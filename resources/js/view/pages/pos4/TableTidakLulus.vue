  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Pengujian POS 4 Tidak Lulus</h3>
      </div>
    ...
    <div class="card-footer">
      <div class="pull-right">
        <div class="overflow-auto">
          <b-pagination v-model="page" :total-rows="pos4.pendaftaransTLulus.total"
            :per-page="pos4.pendaftaransTLulus.per_page" aria-controls="pendaftaransTLulus" v-if="
              pos4.pendaftaransTLulus.data &&
              pos4.pendaftaransTLulus.data.length > 0
            "></b-pagination>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...mapActions("pos4", ["getPendaftaransTLulus"]),
