    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">Pengujian POS 4</h3>
            </div>
        ...
        <div class="card-footer">
            <div class="pull-right">
                <div class="overflow-auto">
                    <b-pagination v-model="page" :total-rows="pos4.pendaftarans.total"
                        :per-page="pos4.pendaftarans.per_page" aria-controls="pendaftarans" v-if="
                            pos4.pendaftarans.data &&
                            pos4.pendaftarans.data.length > 0
                        "></b-pagination>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...mapActions("pos4", ["getPendaftarans"]),
