<template>
    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <select class="form-control" v-model="dataLaporan">
                                ...
                                <option value="kwbubulanan">KWBU</option>
                                <option value="jenisbulanan">Jenis Kendaraan</option>
        ...
        <div class="col-12">
            <div v-if="(loading && dataLaporan == 'kwbubulanan') || (loading && dataLaporan == 'jenisbulanan') || (loading && dataLaporan == 'pelayananbulanan')" class="loading-overlay">
