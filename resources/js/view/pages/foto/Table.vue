  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Pos Foto Kendaraan</h3>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <table class="table">
            ...
            <tbody>
              <tr v-for="pendaftaran, index in foto.pendaftarans.data" :key="pendaftaran.uuid">
    ...
    <div class="card-footer">
      <div class="pull-right">
        <div class="overflow-auto">
          <b-pagination v-model="page" :total-rows="foto.pendaftarans.total" :per-page="foto.pendaftarans.per_page"
            aria-controls="pendaftarans"
            v-if="foto.pendaftarans.data && foto.pendaftarans.data.length > 0"></b-pagination>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...mapActions("foto", ["getPendaftarans"]),
    ...
    uploadfotoCCTV(id) {
      window.open('172.16.99.161/cctv/' + id + '/fotokendaraan', "_blank");
    },
  },
  components: {
