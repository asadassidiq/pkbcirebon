  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Pos Sudah Foto Kendaraan</h3>
      </div>
    ...
    <div class="card-footer">
      <div class="pull-right">
        <div class="overflow-auto">
          <b-pagination v-model="page" :total-rows="foto.pendaftaransFoto.total"
            :per-page="foto.pendaftaransFoto.per_page" aria-controls="pendaftaransFoto"
            v-if="foto.pendaftaransFoto.data && foto.pendaftaransFoto.data.length > 0"></b-pagination>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...mapActions("foto", ["getPendaftaransFoto"]),
