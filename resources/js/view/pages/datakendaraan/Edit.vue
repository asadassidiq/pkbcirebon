                ...
                <div class="accordion" role="tablist">
                  <b-card no-body class="mb-1">
                    <b-card-header header-tag="header" class="p-1 d-flex flex-row justify-content-center gap-2 mb-4" role="tab">
                      ...
                      <b-button v-b-toggle.accordion-7 class="mr-2" variant="outline-primary" @click="relodaRiwayatUji">Riwayat Uji</b-button>
                    </b-card-header>
                    ...
                    <!-- Accordion 7 Content -->
                    <b-collapse id="accordion-7" accordion="my-accordion" @show="isActiveRiwayat = true" @hide="isActiveRiwayat = false" role="tabpanel">
                      <b-card-body>
                        <div class="table-responsive">
                          <table class="table">
                              ...
                              <tbody>
                                  <tr
                                      v-for="riwayatuji in riwayatuji"
                                      :key="riwayatuji.uuid"
                                  >
