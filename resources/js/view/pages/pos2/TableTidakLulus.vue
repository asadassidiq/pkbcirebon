  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Pengujian POS 2 Tidak Lulus</h3>
      </div>
      ...
      <div class="row table-responsive">
        <div class="col-md-12">
          <table class="table">
            ...
            <tbody>
              <tr v-for="(pendaftaran, index) in pos2
    ...
    <div class="card-footer">
      <div class="pull-right">
        <div class="overflow-auto">
          <b-pagination v-model="page" :total-rows="pos2.pendaftaransTLulus.total"
            :per-page="pos2.pendaftaransTLulus.per_page" aria-controls="pendaftaransTLulus" v-if="
              pos2.pendaftaransTLulus.data &&
              pos2.pendaftaransTLulus.data.length > 0
            "></b-pagination>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...mapActions("pos2", ["getPendaftaransTLulus"]),
