  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Pengujian POS 2 Lulus</h3>
      </div>
    ...
    <div class="card-footer">
      <div class="pull-right">
        <div class="overflow-auto">
          <b-pagination v-model="page" :total-rows="pos2.pendaftaransLulus.total"
            :per-page="pos2.pendaftaransLulus.per_page" aria-controls="pendaftaransLulus" v-if="
              pos2.pendaftaransLulus.data &&
              pos2.pendaftaransLulus.data.length > 0
            "></b-pagination>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...mapActions("pos2", ["getPendaftaransLulus"]),
