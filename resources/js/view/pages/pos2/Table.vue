  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Pengujian POS 2</h3>
      </div>
      ...
      <div class="row table-responsive">
        <div class="col-md-12">
          <table class="table">
            ...
            <tbody>
              <tr v-for="(pendaftaran, index) in pos2.pendaftarans
    ...
    <div class="card-footer">
      <div class="pull-right">
        <div class="overflow-auto">
          <b-pagination v-model="page" :total-rows="pos2.pendaftarans.total" :per-page="pos2.pendaftarans.per_page"
            aria-controls="pendaftarans" v-if="
              pos2.pendaftarans.data &&
              pos2.pendaftarans.data.length > 0
            "></b-pagination>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...mapActions("pos2", ["getPendaftarans"]),
