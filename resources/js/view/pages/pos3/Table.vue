  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Pengujian POS 3</h3>
      </div>
      ...
      <div class="row table-responsive">
        <div class="col-md-12">
          <table class="table">
            ...
            <tbody>
              <tr v-for="(pendaftaran, index) in pos3.pendaftarans
    ...
    <div class="card-footer">
      <div class="pull-right">
        <div class="overflow-auto">
          <b-pagination v-model="page" :total-rows="pos3.pendaftarans.total" :per-page="pos3.pendaftarans.per_page"
            aria-controls="pendaftarans" v-if="
              pos3.pendaftarans.data &&
              pos3.pendaftarans.data.length > 0
            "></b-pagination>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...mapActions("pos3", ["getPendaftarans"]),
