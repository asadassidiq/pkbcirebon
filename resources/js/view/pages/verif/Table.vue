  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Verifikator 1</h3>
      </div>
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="pendaftaran, index in verif.pendaftarans.data" :key="pendaftaran.uuid">
                ...
                <td>
                  <router-link v-if="pendaftaran.keterangan == 'Numpang Uji Keluar' || pendaftaran.keterangan == 'Mutasi Keluar'" :to="{ name: 'verif.verifikasi', params: { id: pendaftaran.uuid } }">
                    <i class="fa fa-edit text-success"></i>
                  </router-link>
                  <router-link v-else :to="{ name: 'verif.pengujian', params: { id: pendaftaran.uuid } }">
                    <i class="fa fa-edit text-success"></i>
                  </router-link>
                </td>
              </tr>
    ...
    <div class="card-footer">
      <div class="pull-right">
        <div class="overflow-auto">
          <b-pagination v-model="page" :total-rows="verif.pendaftarans.total" :per-page="verif.pendaftarans.per_page"
            aria-controls="pendaftarans"
            v-if="verif.pendaftarans.data && verif.pendaftarans.data.length > 0"></b-pagination>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...mapActions("verif", ["getPendaftarans"]),
