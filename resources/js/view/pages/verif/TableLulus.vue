  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Verifikator 1 Lulus</h3>
      </div>
      ...
      <div class="row table-responsive">
        <div class="col-md-12">
          <table class="table">
            ...
            <tbody>
              <tr v-for="pendaftaran, index in verif.pendaftaransLulus.data" :key="pendaftaran.uuid">
                <td>{{ index+1 }}</td>
    ...
    <div class="card-footer">
      <div class="pull-right">
        <div class="overflow-auto">
          <b-pagination v-model="page" :total-rows="verif.pendaftaransLulus.total"
            :per-page="verif.pendaftaransLulus.per_page" aria-controls="pendaftaransLulus"
            v-if="verif.pendaftaransLulus.data && verif.pendaftaransLulus.data.length > 0"></b-pagination>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...mapActions("verif", ["getPendaftaransLulus"]),
