    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="radio-inline">
                    ...
                    <router-link
                        :to="{ name: 'pos1.pengujian' }"
                        class="btn btn-sm btn-warning"
                        ><i class="flaticon2-refresh"></i>Revisi
                    </router-link>
                </div>
            </div>
            <div class="form-group">
                ...
                <textarea
                    class="form-control "
                    v-model="pengujian.hasilujipos1"
                    rows="3"
                    disabled="disabled"
                ></textarea>
            </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <textarea
                    class="form-control "
                    v-model="pengujian.hasilujipos2"
                    rows="3"
                    disabled="disabled"
                ></textarea>
            </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <textarea
                    class="form-control "
                    v-model="pengujian.hasilujipos3"
                    rows="3"
                    disabled="disabled"
                ></textarea>
            </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <textarea
                    class="form-control "
                    v-model="pengujian.hasilujipos4"
                    rows="3"
                    disabled="disabled"
                ></textarea>
            </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <textarea
                    class="form-control "
                    v-model="pengujian.hasilujipos5"
                    rows="3"
                    disabled="disabled"
                ></textarea>
            </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <textarea
                    class="form-control "
                    v-model="pengujian.hasilujipos6"
                    rows="3"
                    disabled="disabled"
                ></textarea>
            </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <textarea
                    class="form-control "
                    v-model="pengujian.hasilujipos7"
                    rows="3"
                    disabled="disabled"
                ></textarea>
            </div>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <textarea
                    class="form-control "
                    v-model="pengujian.hasilujipos8"
                    rows="3"
                    disabled="disabled"
                ></textarea>
            </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="form-group">
                ...
                <textarea
                    class="form-control "
                    v-model="pengujian.catatanverif"
                    rows="3"
                ></textarea>
            </div>
        </div>
