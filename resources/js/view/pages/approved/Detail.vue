                            ...
                            <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <b-form-datepicker id="tglpendaftaran" v-model="pendaftaran.tglpendaftaran"
                                                locale="id" disabled></b-form-datepicker>
                                            <p class="text-danger" v-if="errors.tglpendaftaran">
                                                {{ errors.tglpendaftaran[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" v-model="pendaftaran.kodepenerbitans_id" disabled>
                                            ...
                                            <p class="text-danger" v-if="errors.kodepenerbitans_id">
                                                {{ errors.kodepenerbitans_id[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" class="form-control form-control-lg"
                                                placeholder="No Antrian" v-model="pendaftaran.noantrian" :disabled="isFormDisabled" />
                                        </div>
                                    </div>
                                    <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '4'">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                name="nosuratkehilangan" ref="nosuratkehilangan"
                                                placeholder=" No Surat Kehilangan"
                                                v-model="pendaftaran.nosuratkehilangan" />
                                            <p class="text-danger" v-if="errors.nosuratkehilangan">
                                                {{ errors.nosuratkehilangan[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4" v-if="
                                        ...
                                        pendaftaran.kodepenerbitans_id == '11' ||
                                    ...
                                    ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                v-model="pendaftaran.nosurat" placeholder="No Surat" />
                                            <!-- <div class="input-group-append">
                          <button class="btn btn-info" type="button" v-on:click="setSurat">Set</button>
                        </div> -->
                                            <!-- </div> -->
                                            <p class="text-danger" v-if="errors.nosurat">
                                                {{ errors.nosurat[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4" v-if="
                                        pendaftaran.kodepenerbitans_id == '2' ||
                                        pendaftaran.kodepenerbitans_id == '3' ||
                                    ...
                                    ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg text-uppercase"
                                                name="nouji" placeholder="No Uji" @change="caridata()"
                                                v-model="pendaftaran.nouji" />
                                            <p class="text-danger" v-if="errors.nouji">
                                                {{ errors.nouji[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="Nama Pemohon" v-model="pendaftaran.namapemohon" />
                                            <p class="text-danger" v-if="errors.namapemohon">
                                                {{ errors.namapemohon[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="Alamat Pemohon" v-model="pendaftaran.alamatpemohon" />
                                            <p class="text-danger" v-if="errors.alamatpemohon">
                                                {{ errors.alamatpemohon[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="No Telp Pemohon" v-model="pendaftaran.notelp" />
                                            <p class="text-danger" v-if="errors.notelp">
                                                {{ errors.notelp[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    ">
                                        <div class="form-group">
                                            ...
                                            <p class="text-danger" v-if="errors.kepada">
                                                {{ errors.kepada[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    ">
                                        <div class="form-group">
                                            <label> Tujuan</label>
                                            <vSelect label="nama" :options="kotas" v-model="pendaftaran.tujuan"
                                                @input="setKotaTujuan"></vSelect>
                                    ...
                                    <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '10'">
                                        <div class="form-group">
                                            ...
                                            <p class="text-danger" v-if="errors.nokendaraanbaru">
                                                {{ errors.nokendaraanbaru[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '10'">
                                        <div class="form-group">
                                            ...
                                            <p class="text-danger" v-if="errors.namapemilikbaru">
                                                {{ errors.namapemilikbaru[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '10'">
                                        <div class="form-group">
                                            ...
                                            <p class="text-danger" v-if="errors.alamatpemilikbaru">
                                                {{ errors.alamatpemilikbaru[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4" v-if="
                                    ...
                                    ">
                                        <div class="form-group">
                                            ...
                                            <b-form-datepicker id="tglhbsuji" v-model="pendaftaran.tglhbsuji"
                                                locale="id" :disabled="true"></b-form-datepicker>
                                        </div>
                                    </div>
                                    ...
                                    ">
                                        <div class="form-group">
                                            ...
                                            <b-form-datepicker id="tglterakhiruji" v-model="pendaftaran.tglterakhiruji"
                                                locale="id" :disabled="true"></b-form-datepicker>
                                            <p class="text-danger" v-if="errors.tglterakhiruji">
                                                {{ errors.tglterakhiruji[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '12'">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-lg"
                                                    v-model="pendaftaran.nosuratdari" placeholder="No Surat Dari" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id > 10">
                                        <div class="form-group">
                                            <label> No Uji</label>
                                            <input type="text" class="form-control form-control-lg text-uppercase"
                                                name="nouji" placeholder="No Uji" v-model="pendaftaran.nouji" />
                                            <p class="text-danger" v-if="errors.nouji">
                                                {{ errors.nouji[0] }}
                                            </p>
                                        </div>
                                    ...
                                    <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '11'">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="nama"
                                                placeholder=" nama" v-model="pendaftaran.nama" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '11'">
                                        <div class="form-group">
                                            <label>Jenis
                                                <span class="text-danger" v-if="pendaftaran.jenislama">{{
                                                    pendaftaran.jenislama }}</span></label>
                                            <vSelect label="vehicle_type_name" ref="jenis" :options="jenis"
                                                v-model="pendaftaran.jenis" @input="setSubVehicle"
                                                :disabled="!jenis.length"></vSelect>
                                        </div>
                                    </div>
                                    <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '11'">
                                        <div class="form-group">
                                            <label>Model
                                                <span class="text-danger" v-if="pendaftaran.model">{{
                                                    pendaftaran.model
                                                    }}</span></label>
                                            <vSelect label="vehicle_sub_name" ref="subjenis" :options="subjenis"
                                                v-model="pendaftaran.subjenis" @input="setSubVehicleid"
                                                :disabled="!subjenis.length"></vSelect>
                                            <p class="text-danger" v-if="errors.model">
                                                {{ errors.model[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    ">
                                        <div class="form-group">
                                            <label>Merek<span class="text-danger" v-if="pendaftaran.mereklama">{{
                                                    pendaftaran.mereklama }}</span>
                                            </label>
                                            <vSelect label="vehicle_brand_name" ref="merek" :options="mereks"
                                                v-model="pendaftaran.merek" @input="setType" :disabled="!mereks.length">
                                            </vSelect>
                                        </div>
                                    </div>
                                    <div class="col-sm-4" v-if="
                                    ...
                                    ">
                                        <div class="form-group">
                                            <label>Tipe
                                                <span class="text-danger" v-if="pendaftaran.tipelama">{{
                                                    pendaftaran.tipelama
                                                    }}</span></label>
                                            <vSelect label="vehicle_varian_type_name" ref="tipes" :options="tipes"
                                                v-model="pendaftaran.tipe" @input="setVarian" :disabled="!tipes.length">
                                            </vSelect>
                                        </div>
                                    </div>
                                    <div class="col-sm-4" v-if="
                                    ...
                                    <div class="col-sm-12" v-if="
                                        pendaftaran.kodepenerbitans_id == '5' ||
                                        pendaftaran.kodepenerbitans_id == '6'
                                    ">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg text-uppercase"
                                                name="noregistrasikendaraan" placeholder=" No Kendaraan"
                                                v-model="pendaftaran.noregistrasikendaraan" />
                                            <p class="text-danger" v-if="errors.noregistrasikendaraan">
                                                {{ errors.noregistrasikendaraan[0] }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="nama"
                                                placeholder=" nama" v-model="pendaftaran.nama" />
                                            <p class="text-danger" v-if="errors.nama">
                                                {{ errors.nama[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                name="noidentitaspemilik" placeholder=" No Identitas"
                                                v-model="pendaftaran.noidentitaspemilik" />
                                            <p class="text-danger" v-if="errors.noidentitaspemilik">
                                                {{ errors.noidentitaspemilik[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="alamat"
                                                placeholder=" Alamat" v-model="pendaftaran.alamat" />
                                            <p class="text-danger" v-if="errors.alamat">
                                                {{ errors.alamat[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <vSelect label="nama" :options="kotas" v-model="pendaftaran.kota"
                                                @input="setKota"></vSelect>
                                            <p class="text-danger" v-if="errors.kota">
                                                {{ errors.kota[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <vSelect label="nama" :options="kecamatans" v-model="pendaftaran.kecamatan"
                                                @input="setKecamatan" :disabled="disabled1 == 1"></vSelect>
                                            <p class="text-danger" v-if="errors.kecamatan">
                                                {{ errors.kecamatan[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <vSelect label="nama" :options="kelurahans" v-model="pendaftaran.kelurahan"
                                                @input="setKelurahan" :disabled="disabled2 == 1"></vSelect>
                                            <p class="text-danger" v-if="errors.Kelurahan">
                                                {{ errors.Kelurahan[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    ">
                                        <div class="form-group">
                                            <label>No SRUT</label>
                                            <input type="text" class="form-control form-control-lg"
                                                name="nosertifikatreg" placeholder=" No SRUT"
                                                v-model="pendaftaran.nosertifikatreg" />
                                            <p class="text-danger" v-if="errors.nosertifikatreg">
                                                {{ errors.nosertifikatreg[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4" v-if="
                                    ...
                                    ">
                                        <div class="form-group">
                                            ...
                                            <b-form-datepicker id="tglsertifikatreg"
                                                v-model="pendaftaran.tglsertifikatreg" locale="id"></b-form-datepicker>
                                            <p class="text-danger" v-if="errors.tglsertifikatreg">
                                                {{ errors.tglsertifikatreg[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <b-form-datepicker id="tgl_registrasikendaraan"
                                                v-model="pendaftaran.tgl_registrasikendaraan"
                                                locale="id"></b-form-datepicker>
                                            <p class="text-danger" v-if="errors.tgl_registrasikendaraan">
                                                {{ errors.tgl_registrasikendaraan[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4" v-if="
                                    ...
                                    ">
                                        <div class="form-group">
                                            ...
                                            <p class="text-danger" v-if="errors.rancang">
                                                {{ errors.rancang[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control-lg" name="thpembuatan"
                                                placeholder="Tahun Pembuatan" v-model="pendaftaran.thpembuatan"
                                                @focus="('julurdepan')" />
                                            <p class="text-danger" v-if="errors.thpembuatan">
                                                {{ errors.thpembuatan[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="text-danger">Merek<span class="text-success"
                                                    v-if="pendaftaran.mereklama">{{ pendaftaran.mereklama }}</span>
                                            </label>
                                            <vSelect label="vehicle_brand_name" ref="merek" :options="mereks"
                                                v-model="pendaftaran.merek" @input="setType" :disabled="!mereks.length">
                                            </vSelect>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="text-danger">Tipe
                                                <span class="text-success" v-if="pendaftaran.tipelama">{{
                                                    pendaftaran.tipelama }}</span></label>
                                            <vSelect label="vehicle_varian_type_name" ref="tipes" :options="tipes"
                                                v-model="pendaftaran.tipe" @input="setVarian" :disabled="!tipes.length">
                                            </vSelect>
                                            <p class="text-danger" v-if="errors.tipe">
                                                {{ errors.tipe[0] }}
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                ...
                                                <vSelect label="vehicle_varian_name" ref="varian" :options="varians"
                                                    v-model="pendaftaran.varian" @input="setVarianid"
                                                    :disabled="!varians.length"></vSelect>
                                            </div>
                                            <p class="text-danger" v-if="errors.varian">
                                                {{ errors.varian[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="text-danger">Jenis
                                                <span class="text-success" v-if="pendaftaran.jenislama">{{
                                                    pendaftaran.jenislama }}</span></label>
                                            <vSelect label="vehicle_type_name" ref="jenis" :options="jenis"
                                                v-model="pendaftaran.jenis" @input="setSubVehicle"
                                                :disabled="!jenis.length"></vSelect>
                                            <p class="text-danger" v-if="errors.jenis">
                                                {{ errors.jenis[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control-lg" name="isisilinder"
                                                placeholder=" Isi Silinder" v-model="pendaftaran.isisilinder" />
                                            <p class="text-danger" v-if="errors.isisilinder">
                                                {{ errors.isisilinder[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4" v-if="
                                    ...
                                    ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control-lg"
                                                name="dayamotorpenggerak" placeholder=" Daya Motor Penggerak"
                                                v-model="pendaftaran.dayamotorpenggerak" />
                                            <p class="text-danger" v-if="errors.dayamotorpenggerak">
                                                {{ errors.dayamotorpenggerak[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="nomesin"
                                                placeholder="No Mesin" style="text-transform: uppercase"
                                                v-model="pendaftaran.nomesin" />
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control form-control-lg" name="norangka"
                                                style="text-transform: uppercase" ref="norangka"
                                                placeholder=" No Rangka" v-model="pendaftaran.norangka" />
                                            <span class="input-group-text" id="basic-addon2"><a
                                                    href="javascript:void(0)" @click="getDataVTA(pendaftaran.norangka)"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <vSelect label="fuel_name" ref="bahanbakar" :options="fuels"
                                                v-model="pendaftaran.bahanbakar" @input="setFuel"></vSelect>
                                    ...
                                    ">
                                        <div class="form-group">
                                            ...
                                            <p class="text-danger" v-if="errors.peruntukan">
                                                {{ errors.peruntukan[0] }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    ">
                                        <div class="form-group">
                                            <label>Warna</label>
                                            <input type="text" class="form-control form-control-lg" name="warna"
                                                placeholder="Warna" style="text-transform: uppercase"
                                                v-model="pendaftaran.warna" />
                                ...
                                <div class="accordion" role="tablist">
                                    <b-card no-body class="mb-1">
                                        <b-card-header header-tag="header"
                                            class="p-1 d-flex flex-row justify-content-center gap-2 mb-4" role="tab">
                                            <b-button v-b-toggle.accordion-1 class="mr-2" variant="outline-primary"
                                                :class="{ active: isActive }">Ukuran Utama</b-button>
                                            <b-button v-b-toggle.accordion-2 class="mr-2"
                                                variant="outline-primary">Dimensi Bak / Tangki</b-button>
                                            <b-button v-b-toggle.accordion-3 class="mr-2"
                                                variant="outline-primary">Jarak Sumbu</b-button>
                                            <b-button v-b-toggle.accordion-4 class="mr-2"
                                                variant="outline-primary">Berat Kosong</b-button>
                                            <b-button v-b-toggle.accordion-5 class="mr-2" variant="outline-primary">Daya
                                                Angkut</b-button>
                                            <b-button v-b-toggle.accordion-6 class="mr-2"
                                                variant="outline-primary">Catatan Rubah Bentuk</b-button>
                                        </b-card-header>

                                        <!-- Accordion 1 Content -->
                                        <b-collapse id="accordion-1" visible accordion="my-accordion"
                                            @show="isActive = true" @hide="isActive = false" role="tabpanel">
                                            <b-card-body>
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="panjangkendaraan" min="0"
                                                                placeholder="Panjang Kendaraan"
                                                                v-model="pendaftaran.panjangkendaraan"
                                                                @focus="('panjangkendaraan')"
                                                                :readonly="isLocked('panjangkendaraan')" />
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="lebarkendaraan" min="0"
                                                                placeholder="Lebar Kendaraan"
                                                                v-model="pendaftaran.lebarkendaraan"
                                                                @focus="handleFocus('lebarkendaraan')"
                                                                :readonly="isLocked('lebarkendaraan')" />
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="tinggikendaraan" min="0"
                                                                placeholder="Tinggi Kendaraan"
                                                                v-model="pendaftaran.tinggikendaraan"
                                                                @focus="handleFocus('tinggikendaraan')"
                                                                :readonly="isLocked('tinggikendaraan')" />
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="julurbelakang" min="0"
                                                                v-model="pendaftaran.julurbelakang"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="julurdepan" min="0"
                                                                v-model="pendaftaran.julurdepan"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-lg"
                                                                name="bahan" v-model="pendaftaran.bahan"
                                                                :readonly="isLocked('bahan')" />
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="panjangbakatautangki" min="0"
                                                                placeholder="Panjang Bak atau Tangki Muatan"
                                                                v-model="pendaftaran.panjangbakatautangki"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="lebarbakatautangki" min="0"
                                                                placeholder="Lebar Bak atau Tangki Muatan"
                                                                v-model="pendaftaran.lebarbakatautangki"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="tinggibakatautangki" min="0"
                                                                placeholder="Tinggi Bak atau Tangki Muatan"
                                                                v-model="pendaftaran.tinggibakatautangki"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jumlah_sumbu" min="2" placeholder="Jumlah Sumbu"
                                                                v-model="pendaftaran.jumlah_sumbu"
                                                                @focus="handleFocus('jumlah_sumbu')"
                                                                :readonly="isLocked('jumlah_sumbu')" />
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jaraksumbu1_2" min="0"
                                                                placeholder="Jarak Sumbu I-II (mm)"
                                                                v-model="pendaftaran.jaraksumbu1_2"
                                                                @focus="handleFocus('jaraksumbu1_2')"
                                                                :readonly="isLocked('jaraksumbu1_2')" />
                                                    ...
                                                    <div class="col-sm-3" v-if="pendaftaran.jumlah_sumbu > 2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="height" placeholder="Jarak Sumbu II-III (mm)"
                                                                min="0" v-model="pendaftaran.jaraksumbu2_3"
                                                                @focus="handleFocus('jaraksumbu2_3')"
                                                                :readonly="isLocked('jaraksumbu2_3')" />
                                                    ...
                                                    <div class="col-sm-3" v-if="pendaftaran.jumlah_sumbu > 3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="length" placeholder="Jarak Sumbu III-IV (mm)"
                                                                min="0" v-model="pendaftaran.jaraksumbu3_4"
                                                                @focus="handleFocus('jaraksumbu3_4')"
                                                                :readonly="isLocked('jaraksumbu3_4')" />
                                                    ...
                                                    <div class="col-sm-3" v-if="pendaftaran.jumlah_sumbu > 4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jaraksumbu4_5" placeholder="Jarak Sumbu IV-V (mm)"
                                                                min="0" v-model="pendaftaran.jaraksumbu4_5"
                                                                @focus="handleFocus('jaraksumbu4_5')"
                                                                :readonly="isLocked('jaraksumbu4_5')" />
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3" v-if="pendaftaran.jumlah_sumbu > 5">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jaraksumbu5_6" placeholder="Jarak Sumbu V-VI (mm)"
                                                                min="0" v-model="pendaftaran.jaraksumbu5_6"
                                                                @focus="handleFocus('jaraksumbu5_6')"
                                                                :readonly="isLocked('jaraksumbu5_6')" />
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3" v-if="pendaftaran.jumlah_sumbu > 6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jaraksumbu6_7"
                                                                placeholder="Jarak Sumbu VI-VII (mm)" min="0"
                                                                v-model="pendaftaran.jaraksumbu6_7"
                                                                @focus="handleFocus('jaraksumbu6_7')"
                                                                :readonly="isLocked('jaraksumbu6_7')" />
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3" v-if="pendaftaran.jumlah_sumbu > 7">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jaraksumbu7_8"
                                                                placeholder="Jarak Sumbu VII-VIII (mm)" min="0"
                                                                v-model="pendaftaran.jaraksumbu7_8"
                                                                @focus="handleFocus('jaraksumbu7_8')"
                                                                :readonly="isLocked('jaraksumbu7_8')" />
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3" v-if="pendaftaran.jumlah_sumbu > 8">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jaraksumbu8_9"
                                                                placeholder="Jarak Sumbu VIII-IX (mm)" min="0"
                                                                v-model="pendaftaran.jaraksumbu8_9"
                                                                @focus="handleFocus('jaraksumbu8_9')"
                                                                :readonly="isLocked('jaraksumbu8_9')" />
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3" v-if="pendaftaran.jumlah_sumbu > 9">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jaraksumbu9_10"
                                                                placeholder="Jarak Sumbu IX-X (mm)" min="0"
                                                                v-model="pendaftaran.jaraksumbu9_10"
                                                                @focus="handleFocus('jaraksumbu9_10')"
                                                                :readonly="isLocked('jaraksumbu9_10')" />
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3" v-if="pendaftaran.jumlah_sumbu > 10">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jaraksumbu10_11" min="0"
                                                                placeholder="Jarak Sumbu X-XI (mm)"
                                                                v-model="pendaftaran.jaraksumbu10_11"
                                                                @focus="handleFocus('jaraksumbu10_11')"
                                                                :readonly="isLocked('jaraksumbu10_11')" />
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3" v-if="pendaftaran.jumlah_sumbu > 11">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jaraksumbu11_12" min="0"
                                                                placeholder="Jarak Sumbu XI-XII (mm)"
                                                                v-model="pendaftaran.jaraksumbu11_12"
                                                                @focus="handleFocus('jaraksumbu11_12')"
                                                                :readonly="isLocked('jaraksumbu11_12')" />
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="a"
                                                                ...
                                                                placeholder="Wheelbase (mm)" v-model="pendaftaran.a"
                                                                @focus="handleFocus('a')" :readonly="isLocked('a')" />
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label>P (mm)</label>
                                                            <input type="number" class="form-control form-control-lg"
                                                                placeholder="P (mm)" name="p" min="0"
                                                                v-model="pendaftaran.p" @focus="handleFocus('p')"
                                                                :readonly="isLocked('p')" />
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label>Q(mm)</label>
                                                            <input type="number" class="form-control form-control-lg"
                                                                placeholder="Q (mm)" name="q" min="0"
                                                                v-model="pendaftaran.q" @focus="handleFocus('q')"
                                                                :readonly="isLocked('q')" />
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label>R(mm)</label>
                                                            <input type="number" class="form-control form-control-lg"
                                                                placeholder="R (mm)" name="r" min="0"
                                                                v-model="pendaftaran.r" @focus="handleFocus('r')"
                                                                :readonly="isLocked('r')" />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="beratkosong" v-model="pendaftaran.beratkosong"
                                                                @change="setJBI()" @focus="handleFocus('beratkosong')"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="dayaangkutorang" min="0"
                                                                placeholder="Daya Angkut Orang (mm)"
                                                                v-model="pendaftaran.dayaangkutorang" @change="setJBI()"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="dayaangkutbarang" min="0"
                                                                placeholder="Daya Angkut Barang"
                                                                v-model="pendaftaran.dayaangkutbarang"
                                                                @change="setJBI()"
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label>JBB (Kg)</label>
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jbb" min="0" placeholder="JBB"
                                                                v-model="pendaftaran.jbb" @focus="handleFocus('jbb')"
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label>JBKB (Kg)</label>
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jbkb" min="0" placeholder="JBKB (Kg)"
                                                                v-model="pendaftaran.jbkb" @focus="handleFocus('jbkb')"
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label>JBI (Kg)</label>
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jbi" min="0" placeholder="JBI (Kg)"
                                                                v-model="pendaftaran.jbi" @focus="handleFocus('jbi')"
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label>JBKI (Kg)</label>
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="jbki" min="0" placeholder="JBKI (Kg)"
                                                                v-model="pendaftaran.jbki" @focus="handleFocus('jbki')"
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            <label>MST (Kg)</label>
                                                            <input type="number" class="form-control form-control-lg"
                                                                name="mst" min="0" placeholder="MST"
                                                                v-model="pendaftaran.mst" @focus="handleFocus('mst')"
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <vSelect label="kelasjalan_name" ref="kelasjalanterendah"
                                                                :options="kelasjalans"
                                                                v-model="pendaftaran.kelasjalanterendah"
                                                                @input="setKelasJalan"
                                                                :noDrop="isLocked('kelasjalanterendah')"
                                                                :clearable="!isLocked('kelasjalanterendah')"></vSelect>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-lg"
                                                                name="konfigurasisumburoda" min="0"
                                                                placeholder="Konfigurasi Sumbu Roda"
                                                                v-model="pendaftaran.konfigurasisumburoda"
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-lg"
                                                                name="ukuranban" placeholder="Ukuran Ban"
                                                                v-model="pendaftaran.ukuranban"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-lg"
                                                                ...
                                                                v-model="pendaftaran.catatanrubahbentuk"
                            ...
                            <div class="d-flex justify-content-between border-top pt-10"
                                v-if="pendaftaran.kodepenerbitans_id < 11">
                                <div class="mr-2">
...
button:not(.btn-success):not([data-wizard-type="action-prev"]):not([data-wizard-type="action-next"]) {
    pointer-events: none !important;
...
export default {
    ...
    methods: {
        ...
        totalBeratSumbu() {
            this.pendaftaran.beratkosong =
                parseInt(this.pendaftaran.beratsumbu1) +
                parseInt(this.pendaftaran.beratsumbu2) +
                parseInt(this.pendaftaran.beratsumbu3) +
                parseInt(this.pendaftaran.beratsumbu4);
        },
        setKotaTujuan(value) {
        ...
        setJBI() {
            this.pendaftaran.jbi =
                parseInt(this.pendaftaran.beratkosong) +
                parseInt(this.pendaftaran.dayaangkutbarang) +
    ...
    computed: {
        ...
        canNavigate() {
            return true; // Keep navigation enabled
        },
        ...mapState(["errors"]),
        ...
        ...mapState("pendaftaran", {
            ...
            subjenis: (state) => state.subjenis,
            jeniskendaraan: (state) => state.jeniskendaraan,
            fuels: (state) => state.fuels,
            kelasjalans: (state) => state.kelasjalans,
