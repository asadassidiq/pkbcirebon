    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table">
          ...
          <tbody>
            <tr v-for="penyerahan in penyerahan.penyerahansudah.data" :key="penyerahan.id">
              ...
              <td>
                <router-link :to="{ name: 'penyerahan.edit', params: { id: penyerahan.id } }">
    ...
    <div class="card-footer">
      <div class="pull-right">
        <div class="overflow-auto">
          <b-pagination v-model="page" :total-rows="penyerahan.penyerahansudah.total"
            :per-page="penyerahan.penyerahansudah.per_page" aria-controls="penyerahans"
            v-if="penyerahan.penyerahansudah.data && penyerahan.penyerahansudah.data.length > 0"></b-pagination>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...mapActions("penyerahan", ["getPenyerahanSudah", "editPendaftaran"]),
