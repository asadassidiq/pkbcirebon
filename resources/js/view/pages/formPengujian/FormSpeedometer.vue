<template>
  <div class="row">
    <div class="col-sm-6">
      <div class="form-group">
        <input
          ...
          @focus="handleFocus('alatuji_penunjukkecepatan')"
          placeholder="Speedometer"
          v-model="laikjalan.alatuji_penunjukkecepatan"
          v-bind:style=" laikjalan.alatuji_penunjukkecepatan<36 || laikjalan.alatuji_penunjukkecepatan>46 ? 'background-color: #DC143C;' : 'background-color: #F3F6F9;'"
          @input="hasiluji"
        />
      </div>
    </div>
    <div class="col-sm-6">
      <div class="form-group">
        <button class="btn btn-danger btn-sm" :disabled="laikjalan.status_speedometer == '1'" @click="showModal('SPEEDOMETER',laikjalan.alatuji_penunjukkecepatan+' Km/jam')">
...
export default {
  ...
  methods: {
    ...
    ...mapActions("pos4", ["submitCatatan","getCatatan","getAlasan"]),
