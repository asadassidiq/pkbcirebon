    ...
    <div class="form-group row" style="margin:0px;border-bottom: 1px solid">
      ...
      <div class="col-md-3 col-sm-12 col-form-label">
        <div class="input-group">
          <input type="number" ref="alatuji_kedalamanalurban" @focus="handleFocus('alatuji_kedalamanalurban')"
            step="0.1" min="0" max="500" @input="bancheck" v-model="laikjalan.alatuji_kedalamanalurban"
            class="form-control" />
      ...
      <div class="col-md-3 col-sm-6 col-form-label">
        <button class="btn btn-danger btn-sm" :disabled="laikjalan.status_alurban == '1'"
          @click="showModal('Kedalaman alur ban', laikjalan.alatuji_kedalamanalurban)">
