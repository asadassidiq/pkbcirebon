                ...
                <div class="row">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <b-form-datepicker
                        id="tglpendaftaran"
                        v-model="pendaftaran.tglpendaftaran"
                        locale="id"
                      ></b-form-datepicker>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <select
                        class="form-control"
                        v-model="pendaftaran.kodepenerbitans_id"
                      >
                  ...
                  <div
                    class="col-sm-4"
                    v-if="pendaftaran.kodepenerbitans_id == '4'"
                  >
                    <div class="form-group">
                  ...
                  <div
                    class="col-sm-4"
                    v-if="pendaftaran.kodepenerbitans_id == '10'"
                  >
                    <div class="form-group">
                      ...
                      <input
                        ...
                        v-model="pendaftaran.nokendaraanbaru"
                      />
                  ...
                  >
                    <div class="form-group">
                      ...
                      <b-form-datepicker
                        id="tglterakhiruji"
                        v-model="pendaftaran.tglterakhiruji"
                        locale="id"
                        :disabled="true"
                      ></b-form-datepicker>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <input
                          type="text"
                          class="form-control form-control-lg"
                          v-model="pendaftaran.nosuratdari"
                  ...
                  >
                    <div class="form-group">
                      <label
                        ...
                        <span
                          class="text-danger"
                          v-if="pendaftaran.jenislama"
                          >{{ pendaftaran.jenislama }}</span
                        ></label
                      >
                      <vSelect
                        ...
                        ref="jenis"
                        :options="jenis"
                        v-model="pendaftaran.jenis"
                        @input="setSubVehicle"
                        :disabled="!jenis.length"
                      ></vSelect>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div class="form-group">
                      ...
                      <vSelect
                        ...
                        ref="subjenis"
                        :options="subjenis"
                        v-model="pendaftaran.subjenis"
                        @input="setSubVehicleid"
                        :disabled="!subjenis.length"
                      ></vSelect>
                  ...
                  >
                    <div class="form-group">
                      ...
                      <vSelect
                        ...
                        ref="merek"
                        :options="mereks"
                        v-model="pendaftaran.merek"
                        @input="setType"
                        :disabled="!mereks.length"
                      ></vSelect>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div class="form-group">
                      ...
                      <vSelect
                        ...
                        ref="tipes"
                        :options="tipes"
                        v-model="pendaftaran.tipe"
                        @input="setVarian"
                        :disabled="!tipes.length"
                      ></vSelect>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div class="form-group">
                      <label v-if="pendaftaran.kodepenerbitans_id == '11'"
                        >Tujuan Kab/Kota</label
                      >
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <p
                        class="text-danger"
                        v-if="errors.noregistrasikendaraan"
                      >
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <p
                        class="text-danger"
                        v-if="errors.tgl_registrasikendaraan"
                      >
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        v-model="pendaftaran.thpembuatan"
                        @focus="('julurdepan')"
                      />
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="text-danger"
                        ...
                        <span
                          class="text-success"
                          v-if="pendaftaran.tipelama"
                          >{{ pendaftaran.tipelama }}</span
                        ></label
                      >
                      <vSelect
                        label="vehicle_varian_type_name"
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12">
                        ...
                        <vSelect
                          ...
                          ref="varian"
                          :options="varians"
                          v-model="pendaftaran.varian"
                          @input="setVarianid"
                          :disabled="!varians.length"
                        ></vSelect>
                      </div>
                  ...
                  >
                    <div class="form-group">
                      ...
                      <input
                        ...
                        v-model="pendaftaran.isisilinder"
                      />
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <vSelect
                        ...
                        ref="bahanbakar"
                        :options="fuels"
                        v-model="pendaftaran.bahanbakar"
                        @input="setFuel"
                      ></vSelect>
                  ...
                  >
                    <div class="form-group">
                      ...
                      <select
                        class="form-control"
                        v-model="pendaftaran.peruntukan"
                      >
                  ...
                  >
                    <div class="form-group">
                      ...
                      <vSelect
                        ...
                        v-model="pendaftaran.wilayahasal"
                        @input="setAreaFrom"
                      ></vSelect>
              ...
              >
                <div class="accordion" role="tablist">
                  <b-card no-body class="mb-1">
                    <b-card-header
                      header-tag="header"
                      class="p-1 d-flex flex-row justify-content-center gap-2 mb-4"
                      role="tab"
                    >
                      <b-button
                        ...
                        >Ukuran Utama</b-button
                      >
                      <b-button
                        v-b-toggle.accordion-2
                        class="mr-2"
                        variant="outline-primary"
                        >Dimensi Bak / Tangki</b-button
                      >
                      <b-button
                        v-b-toggle.accordion-3
                        class="mr-2"
                        variant="outline-primary"
                        >Jarak Sumbu</b-button
                      >
                      <b-button
                        v-b-toggle.accordion-4
                        class="mr-2"
                        variant="outline-primary"
                        >Berat Kosong</b-button
                      >
                      <b-button
                        v-b-toggle.accordion-5
                        class="mr-2"
                        variant="outline-primary"
                        >Daya Angkut</b-button
                      >
                      <b-button
                        v-b-toggle.accordion-6
                        class="mr-2"
                        variant="outline-primary"
                        >Catatan Rubah Bentuk</b-button
                      >
                    </b-card-header>
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <div class="form-group">
                              ...
                              <p
                                class="text-danger"
                                v-if="errors.panjangbakatautangki"
                              >
                          ...
                          <div class="col-sm-4">
                            <div class="form-group">
                              ...
                              <p
                                class="text-danger"
                                v-if="errors.lebarbakatautangki"
                              >
                          ...
                          <div class="col-sm-4">
                            <div class="form-group">
                              ...
                              <p
                                class="text-danger"
                                v-if="errors.tinggibakatautangki"
                              >
                    ...
                    >
                      <b-card-body>
                        <div class="row">
                          ...
                          <div
                            class="col-sm-3"
                            v-if="pendaftaran.jumlah_sumbu > 2"
                          >
                            <div class="form-group">
                          ...
                          <div
                            class="col-sm-3"
                            v-if="pendaftaran.jumlah_sumbu > 3"
                          >
                            <div class="form-group">
                          ...
                          <div
                            class="col-sm-3"
                            v-if="pendaftaran.jumlah_sumbu > 4"
                          >
                            <div class="form-group">
                              ...
                              <input
                                ...
                                min="0"
                                v-model="pendaftaran.jaraksumbu4_5"
                          ...
                          <div
                            class="col-sm-3"
                            v-if="pendaftaran.jumlah_sumbu > 5"
                          >
                            <div class="form-group">
                              ...
                              <input
                                ...
                                min="0"
                                v-model="pendaftaran.jaraksumbu5_6"
                          ...
                          <div
                            class="col-sm-3"
                            v-if="pendaftaran.jumlah_sumbu > 6"
                          >
                            <div class="form-group">
                          ...
                          <div
                            class="col-sm-3"
                            v-if="pendaftaran.jumlah_sumbu > 7"
                          >
                            <div class="form-group">
                          ...
                          <div
                            class="col-sm-3"
                            v-if="pendaftaran.jumlah_sumbu > 8"
                          >
                            <div class="form-group">
                          ...
                          <div
                            class="col-sm-3"
                            v-if="pendaftaran.jumlah_sumbu > 9"
                          >
                            <div class="form-group">
                          ...
                          <div
                            class="col-sm-3"
                            v-if="pendaftaran.jumlah_sumbu > 10"
                          >
                            <div class="form-group">
                          ...
                          <div
                            class="col-sm-3"
                            v-if="pendaftaran.jumlah_sumbu > 11"
                          >
                            <div class="form-group">
                          ...
                          <div class="col-sm-2">
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu1"
                                min="0"
                                v-model="pendaftaran.beratsumbu1"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu1')"
                                :readonly="isLocked('beratsumbu1')"
                              />
                          ...
                          <div class="col-sm-2">
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu2"
                                min="0"
                                v-model="pendaftaran.beratsumbu2"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu2')"
                                :readonly="isLocked('beratsumbu2')"
                              />
                          ...
                          <div class="col-sm-2">
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu3"
                                min="0"
                                v-model="pendaftaran.beratsumbu3"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu3')"
                                :readonly="isLocked('beratsumbu3')"
                              />
                          ...
                          <div class="col-sm-2">
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu4"
                                min="0"
                                v-model="pendaftaran.beratsumbu4"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu4')"
                                :readonly="isLocked('beratsumbu4')"
                              />
                          ...
                          >
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu5"
                                min="0"
                                v-model="pendaftaran.beratsumbu5"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu5')"
                                :readonly="isLocked('beratsumbu5')"
                              />
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu6"
                                min="0"
                                v-model="pendaftaran.beratsumbu6"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu6')"
                                :readonly="isLocked('beratsumbu6')"
                              />
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu7"
                                min="0"
                                v-model="pendaftaran.beratsumbu7"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu7')"
                                :readonly="isLocked('beratsumbu7')"
                              />
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu8"
                                min="0"
                                v-model="pendaftaran.beratsumbu8"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu8')"
                                :readonly="isLocked('beratsumbu8')"
                              />
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu9"
                                min="0"
                                v-model="pendaftaran.beratsumbu9"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu9')"
                                :readonly="isLocked('beratsumbu9')"
                              />
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu10"
                                min="0"
                                v-model="pendaftaran.beratsumbu10"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu10')"
                                :readonly="isLocked('beratsumbu10')"
                              />
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu11"
                                min="0"
                                v-model="pendaftaran.beratsumbu11"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu11')"
                                :readonly="isLocked('beratsumbu11')"
                              />
                            </div>
                          </div>
                          <div
                          ...
                          >
                            <div class="form-group">
                              ...
                              <input
                                ...
                                name="beratsumbu12"
                                min="0"
                                v-model="pendaftaran.beratsumbu12"
                                @change="
                                  totalBeratSumbu();
                                  setJBI();
                                "
                                @focus="handleFocus('beratsumbu12')"
                                :readonly="isLocked('beratsumbu12')"
                              />
                            </div>
                          </div>
                          <div class="col-sm-4">
                            <div class="form-group">
                              ...
                              <input
                                ...
                                class="form-control form-control-lg"
                                name="beratkosong"
                                v-model="pendaftaran.beratkosong"
                                @change="setJBI()"
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <div class="form-group">
                              ...
                              <input
                                ...
                                v-model="pendaftaran.dayaangkutorang"
                                @change="setJBI()"
                          ...
                          <div class="col-sm-3">
                            <div class="form-group">
                              ...
                              <vSelect
                                ...
                                :clearable="!isLocked('kelasjalanterendah')"
                              ></vSelect>
                              <p
                                class="text-danger"
                                v-if="errors.kelasjalanterendah"
                              >
                          ...
                          <div class="col-sm-3">
                            <div class="form-group">
                              ...
                              <p
                                class="text-danger"
                                v-if="errors.konfigurasisumburoda"
                              >
                        ...
                        <div class="row">
                          <div class="col-sm-4">
                            <div class="form-group">
                              ...
                              <p
                                class="text-danger"
                                v-if="errors.catatanrubahbentuk"
                              >
    ...
    <b-modal id="modalVTA" ref="modalVTA" class="modal" title="Cek Data">
      <div class="form-group">
        ...
        <input
          type="text"
          class="form-control"
          v-model="datavta.nosertifikatreg"
          disabled
        />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input
          type="text"
          class="form-control"
          v-model="datavta.namaperusahaan"
          disabled
        />
      </div>
      <div class="form-group">
        ...
        <input
          type="text"
          class="form-control"
          v-model="datavta.alamatperusahaan"
          disabled
        />
      </div>
      <div class="form-group">
        ...
        <input
          type="text"
          class="form-control"
          v-model="datavta.penanggungjawab"
          disabled
        />
      </div>
    </b-modal>
