              ...
              <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                <div class="row">
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '11'">
                    <div class="form-group">
                      <label>Jenis
                        <span class="text-danger" v-if="pendaftaran.jenislama">{{ pendaftaran.jenislama
                          }}</span></label>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control form-control-lg" name="thpembuatan"
                        placeholder="Tahun Pembuatan" v-model="pendaftaran.thpembuatan" @focus="('julurdepan')" />
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="text-danger">Tipe
                        <span class="text-success" v-if="pendaftaran.tipelama">{{ pendaftaran.tipelama }}</span></label>
                      <vSelect label="vehicle_varian_type_name" ref="tipes" :options="tipes" v-model="pendaftaran.tipe"
                        @input="setVarian" :disabled="!tipes.length"></vSelect>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="text-danger">Jenis
                        <span class="text-success" v-if="pendaftaran.jenislama">{{ pendaftaran.jenislama
                          }}</span></label>
                      <vSelect label="vehicle_type_name" ref="jenis" :options="jenis" v-model="pendaftaran.jenis"
                        @input="setSubVehicle" :disabled="!jenis.length"></vSelect>
    ...
    cekPerubahanData() {
      ...
      for (const key in dataBaru) {
        ...
        if (dataBaru.hasOwnProperty(key)) {
          ...
          if (lama !== baru && baru !== "" && lama !== "" && lama !== "-" && baru !== "null" && baru !== "0") {
            perubahan.push({
              field: key,
              lama: lama,
              baru: baru
