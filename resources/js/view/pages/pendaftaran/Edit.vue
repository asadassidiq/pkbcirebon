          ...
          <div class="col-sm-12 col-xsm-7">
            ...
            <form class="form" id="kt_form">
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <b-form-datepicker id="tglpendaftaran" v-model="pendaftaran.tglpendaftaran" locale="id"></b-form-datepicker>
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '4'">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control  form-control-lg" name="nosuratkehilangan"
                        ref="nosuratkehilangan" placeholder=" No Surat Kehilangan" v-model="pendaftaran.nosuratkehilangan" />
                      <p class="text-danger" v-if="errors.nosuratkehilangan">{{ errors.nosuratkehilangan[0] }}</p>
                    </div>
                  </div>

                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '9' || pendaftaran.kodepenerbitans_id == '10' || pendaftaran.kodepenerbitans_id == '11' || pendaftaran.kodepenerbitans_id == '12'" >
                    <div class="form-group">
                      <label> No Surat</label>
                      <!-- <div class="input-group"> -->
                        <input type="text" class="form-control form-control-lg" v-model="pendaftaran.nosurat" placeholder="No Surat"/>
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '2' || pendaftaran.kodepenerbitans_id == '3' || pendaftaran.kodepenerbitans_id == '4' || pendaftaran.kodepenerbitans_id == '5' || pendaftaran.kodepenerbitans_id == '7' || pendaftaran.kodepenerbitans_id == '9' || pendaftaran.kodepenerbitans_id == '10'">
                    <div class="form-group">
                      <label> No Uji</label>
                      <input
                        type="text"
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '9' || pendaftaran.kodepenerbitans_id == '10'" >
                    <div class="form-group">
                      <label> Kepada</label>
                      <input
                        type="text"
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '9' || pendaftaran.kodepenerbitans_id == '10' ">
                    <div class="form-group">
                      <label> Tujuan</label>
                      <vSelect label="nama" :options="kotas"  v-model="pendaftaran.tujuan" @input="setKotaTujuan" ></vSelect>
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id ==  2 || pendaftaran.kodepenerbitans_id == 3 || pendaftaran.kodepenerbitans_id == 4 || pendaftaran.kodepenerbitans_id == 7 || pendaftaran.kodepenerbitans_id == 9 || pendaftaran.kodepenerbitans_id == 10">
                    <div class="form-group">
                      <label>Tanggal Habis Uji</label>
                      <b-form-datepicker id="tglhbsuji" v-model="pendaftaran.tglhbsuji" locale="id" :disabled="true"></b-form-datepicker>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id ==  2 || pendaftaran.kodepenerbitans_id == 3 || pendaftaran.kodepenerbitans_id == 4 || pendaftaran.kodepenerbitans_id == 7 || pendaftaran.kodepenerbitans_id == 9 || pendaftaran.kodepenerbitans_id == 10">
                    <div class="form-group">
                      ...
                      <b-form-datepicker id="tglterakhiruji" v-model="pendaftaran.tglterakhiruji" locale="id" :disabled="true"></b-form-datepicker>
                    <p class="text-danger" v-if="errors.tglterakhiruji">{{ errors.tglterakhiruji[0] }}</p>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '12'">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control  form-control-lg" v-model="pendaftaran.nosuratdari" placeholder="No Surat Dari"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '12' || pendaftaran.kodepenerbitans_id == '11'">
                    <div class="form-group">
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '11'">
                    <div class="form-group">
                      <label>Jenis <span class="text-danger" v-if="pendaftaran.jenislama">{{ pendaftaran.jenislama }}</span></label>
                      <vSelect label="vehicle_type_name" ref="jenis" :options="jenis"
                        v-model="pendaftaran.jenis" @input="setSubVehicle" :disabled="!jenis.length"></vSelect>
                    </div>
                  </div>
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '11'">
                    <div class="form-group">
                      <label>Model <span class="text-danger" v-if="pendaftaran.model">{{ pendaftaran.model }}</span></label>
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '11' || pendaftaran.kodepenerbitans_id == '12'">
                    <div class="form-group">
                      <label>Merek<span class="text-danger" v-if="pendaftaran.mereklama">{{ pendaftaran.mereklama }}</span> </label>
                      <vSelect label="vehicle_brand_name" ref="merek" :options="mereks"
                        v-model="pendaftaran.merek" @input="setType" :disabled="!mereks.length"></vSelect>
                    </div>
                  </div>
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '11' || pendaftaran.kodepenerbitans_id == '12'">
                    <div class="form-group">
                      <label>Tipe <span class="text-danger" v-if="pendaftaran.tipelama">{{ pendaftaran.tipelama }}</span></label>
                      <vSelect label="vehicle_varian_type_name" ref="tipes" :options="tipes"
                          v-model="pendaftaran.tipe" @input="setVarian" :disabled="!tipes.length"></vSelect>
                    </div>
                  </div>
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '11' || pendaftaran.kodepenerbitans_id == '12'" >
                    <div class="form-group">
                  ...
                  <div class="col-sm-12" v-if="pendaftaran.kodepenerbitans_id == '5' || pendaftaran.kodepenerbitans_id == '6'">
                    <a href="javascript:void(0)" @click="getCheckUji" class="btn btn-sm btn-light-success font-weight-bold" style="width: 100%;">
              ...
              <div class="pb-5" data-wizard-type="step-content">
                <div class="row">
                  <div class="col-sm-6" v-if="pendaftaran.kodepenerbitans_id < 12 || pendaftaran.kodepenerbitans_id > 12">
                    <div class="form-group">
                      <label> No Uji</label>
                      <input
                        type="text"
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id < 12 || pendaftaran.kodepenerbitans_id > 12">
                    <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <vSelect label="nama" :options="kecamatans"  v-model="pendaftaran.kecamatan" @input="setKecamatan" :disabled="disabled1 == 1"></vSelect>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <vSelect label="nama" :options="kelurahans"  v-model="pendaftaran.kelurahan" @input="setKelurahan" :disabled="disabled2 == 1"></vSelect>
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id < 12 || pendaftaran.kodepenerbitans_id > 12">
                    <div class="form-group">
                      ...
                      <b-form-datepicker id="tglsertifikatreg" v-model="pendaftaran.tglsertifikatreg" locale="id"></b-form-datepicker>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <b-form-datepicker id="tgl_registrasikendaraan" v-model="pendaftaran.tgl_registrasikendaraan" locale="id"></b-form-datepicker>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="text-danger">Merek<span class="text-success" v-if="pendaftaran.mereklama">{{ pendaftaran.mereklama }}</span> </label>
                      <vSelect label="vehicle_brand_name" ref="merek" :options="mereks"
                        v-model="pendaftaran.merek" @input="setType" :disabled="!mereks.length"></vSelect>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="text-danger">Tipe <span class="text-success" v-if="pendaftaran.tipelama">{{ pendaftaran.tipelama }}</span></label>
                      <vSelect label="vehicle_varian_type_name" ref="tipes" :options="tipes"
                          v-model="pendaftaran.tipe" @input="setVarian" :disabled="!tipes.length"></vSelect>
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="text-danger">Jenis <span class="text-success" v-if="pendaftaran.jenislama">{{ pendaftaran.jenislama }}</span></label>
                      <vSelect label="vehicle_type_name" ref="jenis" :options="jenis"
                        v-model="pendaftaran.jenis" @input="setSubVehicle" :disabled="!jenis.length"></vSelect>
                  ...
                  <div class="col-sm-6">
                      ...
                      <input type="text" class="form-control  form-control-lg" name="norangka" style="text-transform: uppercase;"
                        ref="norangka" placeholder=" No Rangka" v-model="pendaftaran.norangka"/>
                  ...
                  <div class="col-sm-4" v-if="pendaftaran.kodepenerbitans_id == '5' || pendaftaran.kodepenerbitans_id == '6' ">
                    <div class="form-group">
              ...
              <div class="pb-5" data-wizard-type="step-content" v-if="pendaftaran.kodepenerbitans_id < 12 || pendaftaran.kodepenerbitans_id > 12">
                <div class="accordion" role="tablist">
                  <b-card no-body class="mb-1">
                    <b-card-header header-tag="header" class="p-1 d-flex flex-row justify-content-center gap-2 mb-4" role="tab">
                      <b-button v-b-toggle.accordion-1 class="mr-2" variant="outline-primary" :class="{'active': isActive}" >Ukuran Utama</b-button>
                    ...
                    <!-- Accordion 1 Content -->
                    <b-collapse id="accordion-1" visible accordion="my-accordion" @show="isActive = true" @hide="isActive = false" role="tabpanel">
                      <b-card-body>
                        <div class="row">
                          <div class="col-sm-4">
                            <div class="form-group">
                          ...
                          <div class="col-sm-3">
                            <div class="form-group">
                              ...
                              <vSelect label="kelasjalan_name" ref="kelasjalanterendah" :options="kelasjalans"
                                v-model="pendaftaran.kelasjalanterendah" @input="setKelasJalan"></vSelect>
