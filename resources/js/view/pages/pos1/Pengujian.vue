            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-3 text-center">
                        <div class="form-group">
                            <label>JBB</label>
                            <input type="number" class="form-control  form-control-lg text-center" name="jbb" readonly
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 text-center">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  form-control-lg text-center" name="ukuranban"
                                placeholder="Ukuran Ban" v-model="identitaskendaraan.ukuranban" />
                            <p class="text-danger" v-if="errors.ukuranban">
                                {{ errors.ukuranban[0] }}
                            </p>
                        </div>
                    ...
                    <div class="col-sm-3 text-center">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  form-control-lg text-center" name="rumahrumah"
                                placeholder="Bahan Bakar" v-model="identitaskendaraan.bahanbakar" />
                    ...
                    <div class="col-sm-3 text-center">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  form-control-lg text-center" name="dayaangkutorang"
                                placeholder="Tempat Duduk" v-model="identitaskendaraan.dayaangkutorang" />
                    ...
                    <div class="col-sm-3 text-center">
                        <div class="form-group">
                            <label>Warna</label>
                            <input type="text" class="form-control  form-control-lg text-center" name="warna"
                                placeholder="Warna" v-model="identitaskendaraan.warna" />
