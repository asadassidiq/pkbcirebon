...
export const mutations = {
  ...
  CHECK_HASILUJI(state) {
    if (
      state.identifikasi.notnkb == "0" ||
      state.identifikasi.nouji == "0" ||
      state.identifikasi.norangkalandasan == "0" ||
      state.identifikasi.nomotorpenggerak == "0" ||
      state.identifikasi.ukuranban == "0" ||
      state.identifikasi.bahan == "0"
    ) {
      state.pendaftaran.pos1 = 0;
      mutations.SET_STATUS(state, state.pendaftaran.pos1);
    } else if (
      state.dimensi.panjangkendaraan == "0" ||
      state.dimensi.lebarkendaraan == "0" ||
      state.dimensi.tinggikendaraan == "0" ||
      state.dimensi.panjangbakatautangki == "0" ||
      state.dimensi.tinggibakatautangki == "0" ||
      state.dimensi.julurdepan == "0" ||
      state.dimensi.julurbelakang == "0" ||
      state.dimensi.p == "0" ||
      state.dimensi.a == "0" ||
      state.dimensi.jaraksumbu1_2 == "0" ||
      state.dimensi.jaraksumbu2_3 == "0" ||
      state.dimensi.jaraksumbu3_4 == "0" ||
      state.dimensi.q == "0" ||
      state.dimensi.r == "0" ||
      state.dimensi.b == "0" ||
      state.dimensi.jarakantaradindingterluar == "0" ||
      state.dimensi.groundclearance == "0" ||
      state.dimensi.lebarpintu == "0" ||
      state.dimensi.tinggipintu == "0" ||
      state.dimensi.tinggianaktangga == "0" ||
      state.dimensi.lebaranaktangga == "0" ||
      state.dimensi.lebarlorong == "0" ||
      state.dimensi.tinggitempatberdiri == "0" ||
      state.dimensi.lebartempatduduk == "0" ||
      state.dimensi.jaraktempatduduk == "0" ||
      state.dimensi.lebarpintudarurat == "0" ||
      state.dimensi.panjangakseskeluar == "0" ||
      state.dimensi.lebarakseskeluar == "0" ||
      state.dimensi.jarakantarbumper == "0"
    ) {
      state.pendaftaran.pos1 = 0;
      mutations.SET_STATUS(state, state.pendaftaran.pos1);
    } else if (
      state.depan.kacadepan == "0" ||
      state.depan.penyemprotair == "0" ||
      state.depan.penghapuskaca == "0" ||
      state.depan.bodidepan == "0" ||
      state.depan.lamputandabatas == "0" ||
      state.depan.lampuutamadekat == "0" ||
      state.depan.lampuutamajauh == "0" ||
      state.depan.lampupenunjukarah == "0" ||
      state.depan.lampuposisidepan == "0" ||
      state.depan.lampukabut == "0" ||
      state.depan.kondisitempatnkbdepan == "0"
    ) {
      state.pendaftaran.pos1 = 0;
      mutations.SET_STATUS(state, state.pendaftaran.pos1);
    } else if (
      state.kanan.kacasampingkanan == "0" ||
      state.kanan.kacaspion == "0" ||
      state.kanan.pintusampingkanan == "0" ||
      state.kanan.bodikanan == "0" ||
      state.kanan.apctkanan == "0" ||
      state.kanan.kompresorudara == "0" ||
      state.kanan.bautdanmurroda == "0" ||
      state.kanan.kondisidanukuranban == "0" ||
      state.kanan.perisaikolong == "0" ||
      state.kanan.tutuptangki == "0" ||
      state.kanan.jaraksumbu2_3 == "0" ||
      state.kanan.jaraksumbu3_4 == "0" ||
      state.kanan.q == "0" ||
      state.kanan.r == "0" ||
      state.kanan.lamputandabatassamping == "0" ||
      state.kanan.apar == "0" ||
      state.kanan.rodakelima == "0" ||
      state.kanan.kakipenompangtempelan == "0" ||
      state.kanan.alatperangkaitempelan == "0"
    ) {
      state.pendaftaran.pos1 = 0;
      mutations.SET_STATUS(state, state.pendaftaran.pos1);
    } else if (
      state.belakang.apctbelakang == "0" ||
      state.belakang.lampuposisibelakang == "0" ||
      state.belakang.lampupenunjukarah == "0" ||
      state.belakang.lampurem == "0" ||
      state.belakang.lampumundur == "0" ||
      state.belakang.lamputnkb == "0" ||
      state.belakang.kondisitempatpemasangantnkb == "0" ||
      state.belakang.lamputandabatas == "0" ||
      state.belakang.kondisirodacadangan == "0" ||
      state.belakang.spakbor == "0" ||
      state.belakang.sistempembuangan == "0"
    ) {
      state.pendaftaran.pos1 = 0;
      mutations.SET_STATUS(state, state.pendaftaran.pos1);
    } else if (
      state.kiri.kacasampingkiri == "0" ||
      state.kiri.kacaspionkiri == "0" ||
      state.kiri.kacaspionkiri == "0" ||
      state.kiri.bodikiri == "0" ||
      state.kiri.apctkiri == "0" ||
      state.kiri.kompresorudara == "0" ||
      state.kiri.bautdanmurroda == "0" ||
      state.kiri.kondisidanukuranban == "0" ||
      state.kiri.perisaikolong == "0" ||
      state.kiri.tutuptangki == "0" ||
      state.kiri.lamputandabatassamping == "0" ||
      state.kiri.rodakelima == "0" ||
      state.kiri.kakipenompangtempelan == "0" ||
      state.kiri.alatperangkaitempelan == "0"
    ) {
      state.pendaftaran.pos1 = 0;
      mutations.SET_STATUS(state, state.pendaftaran.pos1);
    } else if (
      state.dalam.ruangkemudi == "0" ||
      state.dalam.tempatduduk == "0" ||
      state.dalam.dashboard == "0" ||
      state.dalam.speedometer == "0" ||
      state.dalam.instrumenpanel == "0" ||
      state.dalam.alatcontrollampu == "0" ||
      state.dalam.tabirmatahari == "0" ||
      state.dalam.pandangankedepan == "0" ||
      state.dalam.rodakemudi == "0" ||
      state.dalam.batangkemudi == "0" ||
      state.dalam.sabukkeselamatan == "0" ||
      state.dalam.perlengkapan == "0" ||
      state.dalam.remparkir == "0" ||
      state.dalam.pedalremkaki == "0" ||
      state.dalam.remgasbuang == "0" ||
      state.dalam.sistemhampa == "0"
    ) {
      state.pendaftaran.pos1 = 0;
      mutations.SET_STATUS(state, state.pendaftaran.pos1);
...
export const actions = {
  ...
  getIdentitaskendaraan({ commit, state }, payload) {
    return new Promise((resolve, reject) => {
      PosService.getIdentitaskendaraan(payload, state.posisi)
        .then((response) => {
  ...
  editPos({ commit, state }, payload) {
    return new Promise((resolve, reject) => {
      PosService.getPos(payload, state.posisi)
        .then((response) => {
          if (
            response.data.result.notnkb == "0" ||
            response.data.result.notnkb == "1"
          ) {
