...
export const mutations = {
  ...
  CHECK_HASILUJI(state) {
    ...
    if (
      state.bawah.rangkalandasan == "0" ||
      state.bawah.motorpenggerak == "0" ||
      state.bawah.sistempenerusdaya == "0" ||
      state.bawah.sistemkemudi == "0" ||
      state.bawah.sistemsuspensi == "0" ||
      state.bawah.sistemroda == "0" ||
      state.bawah.sistemrem == "0"
    ) {
      state.pendaftaran.pos2 = 0;
    } else if (
      (state.identitaskendaraan.jbb <= 3500 &&
        state.identitaskendaraan.thpembuatan < 2010 &&
        state.laikjalan.alatuji_emisiasapbahanbakarsolar > 65) ||
      (state.identitaskendaraan.jbb <= 3500 &&
        state.identitaskendaraan.thpembuatan >= 2010 &&
        state.identitaskendaraan.thpembuatan <= 2021 &&
        state.laikjalan.alatuji_emisiasapbahanbakarsolar > 40) ||
      (state.identitaskendaraan.jbb <= 3500 &&
        state.identitaskendaraan.thpembuatan > 2021 &&
        state.laikjalan.alatuji_emisiasapbahanbakarsolar > 30) ||
      (state.identitaskendaraan.jbb > 3500 &&
        state.identitaskendaraan.thpembuatan < 2010 &&
        state.laikjalan.alatuji_emisiasapbahanbakarsolar > 65) ||
      (state.identitaskendaraan.jbb > 3500 &&
      ...
      (state.identitaskendaraan.jbb > 3500 &&
        state.identitaskendaraan.thpembuatan > 2021 &&
        state.laikjalan.alatuji_emisiasapbahanbakarsolar > 35)
    ) {
      state.laikjalan.status_emisisolar = "0";
      state.pendaftaran.pos2 = 0;
    } else if (
      (isPenumpang(state.identitaskendaraan.jenis) &&
        state.identitaskendaraan.thpembuatan < 2007 &&
        state.laikjalan.alatuji_emisicobahanbakarbensin > 4) ||
      (isPenumpang(state.identitaskendaraan.jenis) &&
        state.identitaskendaraan.thpembuatan >= 2007 &&
        state.identitaskendaraan.thpembuatan <= 2018 &&
        state.laikjalan.alatuji_emisicobahanbakarbensin > 1) ||
      (isPenumpang(state.identitaskendaraan.jenis) &&
        state.identitaskendaraan.thpembuatan > 2018 &&
        state.laikjalan.alatuji_emisicobahanbakarbensin > 0.5) ||
      (isBarang(state.identitaskendaraan.jenis) &&
        state.identitaskendaraan.thpembuatan < 2007 &&
        state.laikjalan.alatuji_emisicobahanbakarbensin > 4) ||
      (isBarang(state.identitaskendaraan.jenis) &&
        state.identitaskendaraan.thpembuatan >= 2007 &&
      ...
      (isPenumpang(state.identitaskendaraan.jenis) &&
        state.identitaskendaraan.thpembuatan < 2007 &&
        state.laikjalan.alatuji_emisihcbahanbakarbensin > 1000) ||
      (isPenumpang(state.identitaskendaraan.jenis) &&
        state.identitaskendaraan.thpembuatan >= 2007 &&
        state.identitaskendaraan.thpembuatan <= 2018 &&
        state.laikjalan.alatuji_emisihcbahanbakarbensin > 150) ||
      (isPenumpang(state.identitaskendaraan.jenis) &&
        state.identitaskendaraan.thpembuatan > 2018 &&
        state.laikjalan.alatuji_emisihcbahanbakarbensin > 100) ||
      (isBarang(state.identitaskendaraan.jenis) &&
        state.identitaskendaraan.thpembuatan < 2007 &&
        state.laikjalan.alatuji_emisihcbahanbakarbensin > 1100) ||
      (isBarang(state.identitaskendaraan.jenis) &&
        state.identitaskendaraan.thpembuatan >= 2007 &&
        state.identitaskendaraan.thpembuatan <= 2018 &&
        state.laikjalan.alatuji_emisihcbahanbakarbensin > 200) ||
      (isBarang(state.identitaskendaraan.jenis) &&
        state.identitaskendaraan.thpembuatan > 2018 &&
        state.laikjalan.alatuji_emisihcbahanbakarbensin > 150)
    ) {
      ...
      state.laikjalan.alatuji_tingkatkebisingan < 83 ||
      state.laikjalan.alatuji_tingkatkebisingan > 118
    ) {
