...
export const mutations = {
  ...
  ASSIGN_PENGUJIAN(state, payload) {
    state.laikjalan = {
      ...
      alatuji_lampuutamapenyimpanganlampukanan:
        payload.alatuji_lampuutamapenyimpanganlampukanan,
      alatuji_lampuutamapenyimpanganlampukiri:
        payload.alatuji_lampuutamapenyimpanganlampukiri,
  ...
  CHECK_HASILUJI(state) {
    if (state.laikjalan.alatuji_lampuutamakekuatanpancarlampukanan < 12000) {
      ...
      state.laikjalan.alatuji_lampuutamakekuatanpancarlampukiri < 12000
    ) {
      state.pendaftaran.pos3 = "0";
      state.laikjalan.status_intensitaslampu = "0";
    } else {
    ...
    if (state.laikjalan.alatuji_lampuutamapenyimpanganlampukiri > 1.09) {
      ...
      state.laikjalan.alatuji_lampuutamapenyimpanganlampukanan > 0.34
    ) {
      state.laikjalan.status_penyimpanganlampu = "0";
      state.pendaftaran.pos3 = "0";
      state.laikjalan.status_penyimpanganlampu = "0";
    ...
    if (
      state.laikjalan.alatuji_kincuprodadepan > 5 ||
      state.laikjalan.alatuji_kincuprodadepan < -5
    ) {
      state.pendaftaran.pos3 = "0";
