    ...
    <div id="form-noborder">
        <div>
            <table class="table table-borderless">
                <tr>
                    <td class="aligncenter" colspan="8"><h6>KARTU INDUK UJI BERKALA MOBIL BUS</h6></td>
                ...
                <tr class ="aligncenter">
                    ...
                    <td colspan="4" class="rightborder">KEISTIMEWAAN
                <tr>
                    ...
                    <td>:</td>
                    <td></td>
                    <td class="allborder" colspan="4" rowspan="4"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td></td>
                    <td colspan="3"> d. Banyak Tempat Berdiri</td>
                    <td>:</td>
                    <td></td>
                    <td class="leftborder" colspan="2">Tinggi ruang penumpang</td>
                    <td>: {{ $data->tinggitempatberdiri }}</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td></td>
                    <td colspan="3"> e. Jarak anak tangga paling bawah dari tanah</td>
                    <td>: </td>
                    <td></td>
                    <td class="leftborder" colspan="2">Lebar Pintu</td>
                    <td>:{{ $data->lebarpintu }}</td>
                    <td class="rightborder"></td>
                </tr>
                <tr>
                    ...
                    <td>:{{ $data->norangka }}</td>
                    <td></td>
                    <td colspan="3"> f. Lebar anak tangga</td>
                    <td>:{{ $data->lebaranaktangga }}</td>
                    <td></td>
                    <td class="leftborder space" colspan="2" rowspan="2">Ukuran tempat keluar darurat</td>
                    <td rowspan="2">:</td>
                    <td class="rightborder" rowspan="2"></td>
               </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="leftborder" colspan="2">- Panjang</td>
                    <td>:</td>
                    <td class="rightborder"></td>
                </tr>
                <tr>
                    ...
                    <td>r : {{ $data->r }}</td>
                    <td></td>
                    <td class="leftborder" colspan="2">- Lebar</td>
                    <td>: {{ $data->lebarpintudarurat }}</td>
                    <td class="rightborder"></td>                
                </tr>
                <tr>
                    <td class="leftborder">11. Tinggi Total</td>
                    ...
                    <td>b : {{ $data->b }}</td>
                    <td></td>
                    <td class="leftborder" colspan="2">Jarak antar tempat duduk</td>
                    <td>: {{ $data->jaraktempatduduk }}</td>
                    <td class="rightborder"></td> 
                </tr>
                <tr>
                    ...
                    <td class="leftborder" colspan="2" rowspan="3">Lebar tempat duduk</td>
                    <td rowspan="3">: {{ $data->lebartempatduduk }}</td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td class="rightborder alignright">(kg)</td>
                    <td class="">No. SUT atau SK Rancang Bangun</td>
                    <td>:</td>
                    <td></td>
