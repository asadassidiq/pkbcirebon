<!DOCTYPE html>
<head>
    <title>Lampiran 1 - Halaman Depan</title>
    <meta charset="utf-8">
    ...
    <div id="form-noborder">
        <div>
            <table class="table table-borderless">
                <tr>
                    <td class="aligncenter" colspan="8"><h6>KARTU INDUK UJI BERKALA MOBIL PENUMPANG UMUM</h6></td>
                ...
                <tr class ="aligncenter">
                    ...
                    <td colspan="4" class="rightborder bottomborder">KEISTIMEWAAN</td>           
                </tr>
                <tr>
                    ...
                    <td colspan="4" rowspan="8" class="rightborder"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="leftborder">4. Tahun Pembusatan/Perakitan</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td></td>
                    <td colspan="3"> d. Keterangan lain</td>
                    <td>:</td>
                    <td class="rightborder"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>: <span style="margin-left:20px;margin-right:10px">1-2 :</span> {{ $data->jaraksumbu1_2 }}</td>
                    <td>mm</td>
                    <td></td>
                    <td>2-3 :</td>
                    <td></td>
                    <td>mm, 3-4 :</td>
                    <td> mm</td>
                    <td class="leftborder topborder rightborder" colspan="4">Jarak antar tempat duduk : {{ $data->jaraktempatduduk }}</td>  
                </tr>
                <tr>
                    ...
                    <td>r : {{ $data->r }}</td>
                    <td></td>
                    <td class="leftborder rightborder" colspan="4" rowspan="5">Lebar tempat duduk : {{ $data->lebartempatduduk }}</td> 
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2"> mm</td>
                    <td class="allborder" colspan="4">SERTIFIKAT REGISTRASI UJI TIPE</td>  
                </tr>
                <tr>
                    <td class="allborder aligncenter" colspan="4" rowspan="2">BERAT, DAYA ANGKUT, KELAS JALAN YANG PALING RENDAH, UKURAN BAN YANG DIIZINKAN</td>
                    <td>Nama APM</td>
                    <td>:</td>
                ...
                <tr>
                    <td class="leftborder">a. Jumlah berat yang diperbolehkan</td>
                    <td>: {{ $data->jbb }}</td>
                    <td></td>
                    ...
                    <td class="rightborder" colspan="2"></td>
                    <td class="topborder bottomborder rightborder aligncenter" colspan="4">Foto</td>
                </tr>
                <tr>
                    <td class="leftborder">b. Jumlah berat kombinasi yang diperbolehkan</td>
                    <td>: {{ $data->jbkb }}</td>
                    <td></td>
                    <td class="rightborder alignright">(kg)</td>
                    ...
                    <td colspan="2" rowspan="6" class="col">
                         <img style="width:110px;height:95px;position: absolute;" src="{{url('/normal_images/'.$data->nouji.'-tampakdepan.jpg')}}">
                    </td>
                    <td colspan="2" rowspan="6" class="leftborder rightborder col">
                        <img style="width:110px;height:95px;position: absolute;" src="{{url('/normal_images/'.$data->nouji.'-tampakbelakang.jpg')}}">
                    </td>
                </tr>
                <tr>
                    <td class="leftborder">c. Berat kendaraan sumbu ke-1</td>
                ...
                <tr>
                    <td class="leftborder">d. Berat kendaraan sumbu ke-2</td>
                ...
                <tr>
                    <td class="leftborder">e. Berat kendaraan sumbu ke-3</td>
                    <td>: {{ $data->beratsumbu3 }}</td>
                    <td></td>
                    <td class="alignright rightborder">(kg)</td>
                    <td>APM atau Karoseri</td>
                    <td>:</td>
                    <td class="rightborder" colspan="2"></td>
                </tr>
                <tr>
                    <td class="leftborder">f. Berat kendaraan sumbu ke-4</td>
                ...
                <tr>
                    <td class="leftborder">g. Berat kendaraan sumbu ke-5</td>
                    <td>:</td>
                    <td></td>
                    <td class="alignright rightborder">(kg)</td>
                    <td>F.O.H.</td>
                ...
                <tr>
                    <td class="leftborder">h. Jumlah (Berat kosong)</td>
                    ...
                    <td>:</td>
                    <td class="rightborder" colspan="2"></td>
                    <td class="bottomborder rightborder aligncenter" colspan="2">Tampak Depan</td>
                    <td class="bottomborder rightborder aligncenter" colspan="2">Tampak Belakang</td>
                </tr>
                <tr>
                    <td class="leftborder">i. Daya angkut orang : {{ $data->dayaangkutorang }} Orang</td>
                    ...
                    <td class="rightborder" colspan="2"></td>
                    <td colspan="2" rowspan="6" class="col">
                        <img style="width:110px;height:95px;position: absolute;" src="{{url('/normal_images/'.$data->nouji.'-tampakkanan.jpg')}}">
                    </td>
                    <td colspan="2" rowspan="6" class="leftborder rightborder col">
                        <img style="width:110px;height:95px;position: absolute;" src="{{url('/normal_images/'.$data->nouji.'-tampakkiri.jpg')}}">
                    </td>
                </tr>
                <tr>
                    <td class="leftborder">j. Daya angkut barang</td>
                ...
                <tr>
                    <td class="leftborder">k. Junlah berat yang diizinkan</td>
                    <td>: {{ $data->jbi }}</td>
                    <td></td>
                    <td class="rightborder alignright">(kg)</td>
                ...
                <tr>
                    <td class="leftborder">l. Jumlah berat kombinasi yang diizinkan</td>
                    <td>: {{ $data->jbki }}</td>
                    <td></td>
                    <td class="rightborder alignright">(kg)</td>
                    <td>Warna</td>
                ...
                <tr>
                    <td class="leftborder">m. Muatan sumbu yang paling berat</td>
                    <td>: {{ $data->mst }}</td>
                    <td></td>
                    <td class="rightborder alignright">(kg)</td>
                    <td class="rightborder" colspan="4">Kekuatan Sumbu</td>
                </tr>
                <tr>
                    <td class="leftborder">n. Kelas jalan yang terendah</td>
                    <td>: {{ $data->kelasjalanterendah }}</td>
                    <td colspan="2"></td>
                    <td class="leftborder">- Sumbu 1</td>
                    <td>:</td>
                    <td class="rightborder" colspan="2"></td>
                <tr>
                <tr>
                    <td class="leftborder">o. Pemakaian ban yang diizinkan pada sumbu 1</td>
                    <td>: {{ $data->ukuranban }}</td>
                    <td colspan="2"></td>
                    <td class="leftborder">- Sumbu 2</td>
                    <td>:</td>
                    <td colspan="2"></td>
                    <td class="leftborder bottomborder" colspan="2">Tampak Samping Kanan</td>
                    <td class="leftborder bottomborder rightborder" colspan="2">Tampak Samping Kiri</td>
                </tr>
                <tr>
                    <td class="leftborder">p. Pemakaian ban yang diizinkan pada sumbu 2</td>
                    <td>: {{ $data->ukuranban }}</td>
                    <td colspan="2"></td>
                    <td class="leftborder">- Sumbu 3</td>
                    <td>:</td>
                    <td colspan="2"></td>
                    <td class="leftborder bottomborder aligncenter" colspan="2">Di Buat Oleh : </td>
                    <td class="leftborder bottomborder rightborder aligncenter" colspan="2">Mengetahui : </td>
                </tr>
                <tr>
                    <td class="leftborder">q. Pemakaian ban yang diizinkan pada sumbu 3</td>
                    <td>:</td>
                    <td colspan="2"></td>
                    <td class="leftborder">- Sumbu 4</td>
                    <td>:</td>
                    <td colspan="2"></td>
                    <td class="bottomborder leftborder col aligncenter space" colspan="2" rowspan="4">TTD, Nama dan Tingkat Jenjang Kompetensi Penguji</td>
                    <td class="bottomborder leftborder rightborder aligncenter space" colspan="2" rowspan="4">TTD, Nama dan Jabatan Penanggung Jawab Unit Pelaksana Uji Berkala</td>
                </tr>
                <tr>
                    <td class="leftborder">r. Pemakaian ban yang diizinkan pada sumbu 4</td>
                    <td>:</td>
                    <td colspan="2"></td>
                ...
                <tr>
                    <td class="leftborder">s. Pemakaian ban yang diizinkan pada sumbu 5</td>
                    <td>:</td>
                    <td colspan="2"></td>
                    <td class="bottomborder leftborder" rowspan="2">Tanggal Pembuatan Kartu Induk</td>
                    <td class="bottomborder" rowspan="2">: {{ $tglcetak }}</td>
                    <td class="bottomborder" colspan="2" rowspan="2"></td>
                </tr>
                <tr>
                    <td class="bottomborder leftborder">t. Konfigurasi Sumbu Roda</td>
                    <td class="bottomborder">: {{ $data->konfigurasisumburoda }}</td>
                    <td class="bottomborder rightborder" colspan="2"></td>
                </tr>
                <tr>
                    <td colspan="11" class="alignright"></td>
                </tr>
                <tr>
                    <td colspan="11" class="alignright"></td>
                </tr>
