    ...
    <div id="form-noborder">
        <div>
            <table class="table table-borderless">
                <tr>
                    <td class="aligncenter" colspan="8"><h6>KARTU INDUK UJI BERKALA KERETA GANDENGAN ATAU TEMPELAN</h6></td>
                ...
                <tr>
                    <td class="leftborder">5. Tempat/Tgl Uji Berkala Pendaftaran</td>
                    <td>:</td>
                    <td></td>
                ...
                <tr>
                    <td class="leftborder">6. Tempat/Tgl Uji Berkala Pertama</td>
                    <td>:</td>
                    <td></td>
                    <td colspan="3"> e. STP</td>
                    <td>:</td>
                    <td></td>
                    <td class="leftborder rightborder topborder" colspan="4">Jarak bak thd bagian terluar ban :  {{ $data->jarakantarbumper }} </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>mm</td>
                    <td></td>
                    <td colspan="2">2-3 : {{ $data->jaraksumbu2_3 }}</td>
                    <td colspan="2">mm, 3-4 :  {{ $data->jaraksumbu3_4 }} mm</td>
                ...
                <tr>
                    ...
                    <td class="leftborder" colspan="2" rowspan="6">
                        <img style="width:185px;height:95px;position: absolute;" src="{{url('/normal_images/'.$data->nouji.'-tampakdepan.jpg')}}">
                    </td>
                    <td class="leftborder rightborder" colspan="2" rowspan="6">
                        <img style="width:170px;height:95px;position: absolute;" src="{{url('/normal_images/'.$data->nouji.'-tampakbelakang.jpg')}}">
                    </td>
                </tr>
                 <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" rowspan="5" class="col">
                         <img style="width:185px;height:95px;position: absolute;" src="{{url('/normal_images/'.$data->nouji.'-tampakkanan.jpg')}}">
                    </td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td colspan="2"></td>
                    <td class="leftborder bottomborder space" rowspan="2">Tanggal Pembuatan Kartu Induk</td>
