...
<body>
    <div class="container" id="form">
        <table class="container">
            ...
            <td class="col-title"><p class="letter-name space"><b>Laporan Pelaksanaan Pengujian Kendaraan Bermotor<br> Pada UPT PKB Dinas Perhubungan Kabupaten Mimika <br> Bulan {{ $tglprint }}</b></p></td>
