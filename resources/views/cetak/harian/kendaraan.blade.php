    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-8 align-self-center">
                <h3><p class="text-center"><b>PEMERINTAH KABUPATEN MIMIKA</b></p></h3>                   
                <h2><p class="text-center"><b>DINAS PERHUBUNGAN</b></p></h2>    
                <h3><p class="text-center"><b>UPT PENGUJIAN KENDARAAN BERMOTOR</b></p></h3> 
                <h6><p class="text-center"><b>Jl. Mahkota Jalur 1 Kel.Timika Jaya Kec.Mimika Baru</b></p></h6>  
                <h6><p class="text-center"><b>Telp.0901-323630, Email: unitpengujikabmmk@yahoo.com, Kode Pos : 99910</b></p></h6> 
            </div>
            <div class="col-1">
            </div>
        </div>
