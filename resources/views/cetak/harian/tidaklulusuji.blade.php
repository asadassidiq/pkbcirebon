...
<body onload="window.print();">
    <div class="container-fluid">
        ...
        <div class="row">
             <div class="col-12">
               <h4>DAFTAR RINCIAN KENDARAAN TIDAK LULUS UJI</h4>
                ...
                <tbody>
                  ...
                  @foreach ($tidaklulus as $data) 
                    <tr>
                      ...
                      @else
                        @php
                            $catatans = App\Models\Catatan::where('pendaftaran_id', $data['pendaftaran_id'])->where('status','1')->get();
                        @endphp
                        @foreach ($catatans as $catatan)
                          {{ $catatan->nama }} : {{ $catatan->hasiluji }} {{ $catatan->alasan }},
                        @endforeach
                      @endif
                      </td>
                    </tr>
