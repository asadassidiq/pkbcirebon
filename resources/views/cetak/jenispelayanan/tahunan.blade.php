        ...
        <div class="row">
            <table class="table table-bordered">
                <thead>
                    ...
                    <tr>
                        <th scope="col" rowspan="2">Uji Pertama</th>
                        <th scope="col" rowspan="2">Uji Berkala</th>
                        <th scope="col" rowspan="2">Numpang Uji Masuk</th>
                        <th scope="col" rowspan="2">Rubah Bentuk</th>
                        <th scope="col" rowspan="2">Mutasi Masuk</th>
                        <th scope="col" rowspan="2">Jumlah</th>
                        <th scope="col" rowspan="2">Lulus</th>
                        <th scope="col" rowspan="2">Tidak</th>
                    </tr>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @else
                            @php
                            $nukeluar1 = ((int)$nukeluar/(int)$jumlah)*100;
                            @endphp
                            <td class="text-center">{{ $nukeluar1 }} %</td>
                            @endif
                            @if($mutasikeluar == 0)
                            ...
                            @else
                            @php
                            $mutasikeluar1 = ((int)$mutasikeluar/(int)$jumlah)*100;
                            @endphp
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            $lulus2 = 0;
                            @endphp
                            <td class="text-center"> {{ round($lulus2,3) }} %</td>
                            @else
                            @php
                            $lulus2 = ((int)$lulus/(int)$jumlah)*100;
                            @endphp
                            <td class="text-center">{{ round($lulus2,3) }} %</td>
                            @endif
                            @if($tidaklulus == 0)
                            ...
                            $tidaklulus2 = 0;
                            @endphp
                            <td class="text-center"> {{ round($tidaklulus2,3) }} %</td>
                            @else
                            @php
                            $tidaklulus2 = ((int)$tidaklulus/(int)$jumlah)*100;
                            @endphp
                            <td class="text-center">{{ round($tidaklulus2,3) }} %</td>
                            @endif
                        </tr>
