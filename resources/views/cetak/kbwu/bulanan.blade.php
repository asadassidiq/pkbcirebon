...
<body>
    <div class="cont">
        <div class="row text-center">
            ...
            <div class="col-sm-6">
                <p><b>Laporan Pelaksanaan Pengujian Kendaraan Bermotor<br> Pada UPT PKB Dinas Perhubungan Kabupaten Mimika <br> Bulan {{ $tglprint }}</b></p>
            </div>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-center" rowspan="3">Uji Ulang</th>
