...
<body onload="window.print();">
    <page>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <h4>JUMLAH KENDARAAN BERMOTOR WAJIB UJI KABUPATEN MMIMIKA</h4>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" rowspan="3" class="text-center">MPU</th>
                                <th scope="col" rowspan="2" colspan="7" class="text-center">MOBIL BUS</th>
                                <th scope="col" colspan="3" class="text-center">MOBIL BARANG</th>
                                <th scope="col" rowspan="3" class="text-center">JUMLAH</th>
                            </tr>
                            <tr>
                                <th>KECIL</th>
                                <th>SEDANG</th>
