<table>
    <thead>
      <tr>
          <th colspan="9"><b>DAFTAR DATA KENDARAAAN</b></th>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <th scope="col" class="text-center">TGL UJI PERTAMA</th>
        <th scope="col" class="text-center">TGL UJI</th>
        <th scope="col" class="text-center">MASA BERLAKU UJI</th>
      </tr>
    </thead>
    <tbody>
      @php 
      ...
      @foreach ($kendaraan as $data) 
        <tr>
          ...
          <td>{{ $data['tglpertama'] }}</td>
          <td>{{ $data['tgluji'] }}</td>
          @if(!empty($data['tgluji']))
            <td>{{ date('Y-m-d', strtotime($data['tgluji']. ' + 6 Months')) }}</td>
          @else
            <td></td>
          @endif
        </tr>
