<table>
    <thead>
      <tr>
          <th colspan="39"><b>DAFTAR RINCIAN KENDARAAAN UJI LUAR</b></th>
      </tr>
      <tr>
          <th colspan="39"><b>PERIODE : {{ $tglprint }}</b></th>
      </tr>
      <tr>
    ...
    <tbody>
      ...
      @foreach ($data['datajm'] as $dt) 
          <tr>
              ...
              <?php $tgl = $data['tgl'] ?>
              @if($dt['jenis'] === '10')
                  <td style="font-size:12px">MUTASI KELUAR</td>
              @elseif($dt['jenis'] === '9')
                  <td style="font-size:12px">NU KELUAR</td>
              @endif
