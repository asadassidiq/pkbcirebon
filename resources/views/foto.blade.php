            ...
            <form action="{{ url('/intervention_postimage') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="media text-muted pt-3">
                    <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                        ...
                        <input type="file" name="image1" class="form-control-file" id="exampleFormControlFile1" accept="image/*">
                    </p>
                </div>
                <div class="media text-muted pt-3">
                    <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                        <label for="exampleFormControlFile1">Foto Tampak Kanan</label>
                        <input type="file" name="image2" class="form-control-file" id="exampleFormControlFile1" accept="image/*">
                    </p>
                </div>
                <div class="media text-muted pt-3">
                    <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                        <label for="exampleFormControlFile1">Foto Tampak Belakang</label>
                        <input type="file" name="image3" class="form-control-file" id="exampleFormControlFile1" accept="image/*">
                    </p>
                </div>
                <div class="media text-muted pt-3">
                    <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                        <label for="exampleFormControlFile1">Foto Tampak Kiri</label>
                        <input type="file" name="image4" class="form-control-file" id="exampleFormControlFile1" accept="image/*">
                    </p>
                </div>
