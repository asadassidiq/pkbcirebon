...
class jenisExportTahunan implements FromView
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        foreach ($bulan as $dt) {
            ...
            $arr = array(
                ...
                'mobilpenumpang' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereIn('jeniskendaraan', ['Mobil Penumpang Sedan','Mobil Penumpanb Bukan Sedan'])->where('kodepenerbitans_id', '1')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                ...
                'lainlain' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereNotIn('jeniskendaraan',['Mobil Penumpang Bukan Sedan','Mobil Penumpang Sedan','Mobil Bus Kecil','Mobil Bus Sedang','Mobil Bus Besar','Mobil Bus Maxi','Kereta Tempelan','Kereta Gandeng'])->whereNotIn('model', ['PICK UP','PICK UP BOX','TRUCK','LIGHT TRUCK','DUMP TRUCK','TRUCK BOX','TRACTOR HEAD','DELIVERY VAN','DOUBLE CABIN','TRUCK BAK CRANE','CAR CARREIR','TRUCK TANGKI','BLINDVAN','TRONTON','FLAT DECK','Kereta Tempelan','Kereta Gandeng'])->where('kodepenerbitans_id', '1')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
            );
        ...
        foreach ($bulan as $dt) {
            ...
            $arr = array(
                ...
                'mobilpenumpang' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereIn('jeniskendaraan', ['Mobil Penumpang Sedan','Mobil Penumpanb Bukan Sedan'])->where('kodepenerbitans_id', '2')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                ...
                'lainlain' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereNotIn('jeniskendaraan',['Mobil Penumpang Bukan Sedan','Mobil Penumpang Sedan','Mobil Bus Kecil','Mobil Bus Sedang','Mobil Bus Besar','Mobil Bus Maxi','Kereta Tempelan','Kereta Gandeng'])->whereNotIn('model', ['PICK UP','PICK UP BOX','TRUCK','LIGHT TRUCK','DUMP TRUCK','TRUCK BOX','TRACTOR HEAD','DELIVERY VAN','DOUBLE CABIN','TRUCK BAK CRANE','CAR CARREIR','TRUCK TANGKI','BLINDVAN','TRONTON','FLAT DECK','Kereta Tempelan','Kereta Gandeng'])->where('kodepenerbitans_id', '2')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
            );
        ...
        foreach ($bulan as $dt) {
            ...
            $arr = array(
                ...
                'mobilpenumpang' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereIn('jeniskendaraan', ['Mobil Penumpang Sedan','Mobil Penumpanb Bukan Sedan'])->where('kodepenerbitans_id', '5')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                ...
                'lainlain' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereNotIn('jeniskendaraan',['Mobil Penumpang Bukan Sedan','Mobil Penumpang Sedan','Mobil Bus Kecil','Mobil Bus Sedang','Mobil Bus Besar','Mobil Bus Maxi','Kereta Tempelan','Kereta Gandeng'])->whereNotIn('model', ['PICK UP','PICK UP BOX','TRUCK','LIGHT TRUCK','DUMP TRUCK','TRUCK BOX','TRACTOR HEAD','DELIVERY VAN','DOUBLE CABIN','TRUCK BAK CRANE','CAR CARREIR','TRUCK TANGKI','BLINDVAN','TRONTON','FLAT DECK','Kereta Tempelan','Kereta Gandeng'])->where('kodepenerbitans_id', '5')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
            );
        ...
        foreach ($bulan as $dt) {
            ...
            $arr = array(
                'tgl'  => $bulan_ini1,
                'kbwu' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('kodepenerbitans_id', '9')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'mobilpenumpang' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereIn('jeniskendaraan', ['Mobil Penumpang Sedan','Mobil Penumpanb Bukan Sedan'])->where('kodepenerbitans_id', '9')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'buskecil' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan',  'Mobil Bus Kecil' )->where('kodepenerbitans_id', '9')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'bussedang' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan', 'Mobil Bus Sedang' )->where('kodepenerbitans_id', '9')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'busbesar' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan', 'Mobil Bus Besar' )->where('kodepenerbitans_id', '9')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'busmaxi' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan', 'Mobil Bus Maxi' )->where('kodepenerbitans_id', '9')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'pickup' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'PICK UP')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'pickupbox' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'PICK UP BOX')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'truck' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'TRUCK')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'lighttruck' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'LIGHT TRUCK')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'dumptruck' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'DUMP TRUCK')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'truckbox' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'TRUCK BOX')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'traktorhead' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'like', '%' . 'TRACTOR HEAD' . '%')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'deliveryvan' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'DELIVERY VAN')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'doublecabin' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'DOUBLE CABIN')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'truckbakcrane' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'TRUCK BAK CRANE')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'carcarrier' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'CAR CARREIR')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'trucktangki' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'TRUCK TANGKI')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'blindvan' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'BLINDVAN')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'tronton' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'TRONTON')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'flatdeck' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'FLAT DECK')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '9')->count(),
                'keretatempelan' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan', 'like', '%' . 'Kereta Tempelan' . '%')->where('kodepenerbitans_id', '9')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'keretagandeng' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan', 'like', '%' . 'Kereta Gandeng' . '%')->where('kodepenerbitans_id', '9')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'lainlain' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereNotIn('jeniskendaraan',['Mobil Penumpang Bukan Sedan','Mobil Penumpang Sedan','Mobil Bus Kecil','Mobil Bus Sedang','Mobil Bus Besar','Mobil Bus Maxi','Kereta Tempelan','Kereta Gandeng'])->whereNotIn('model', ['PICK UP','PICK UP BOX','TRUCK','LIGHT TRUCK','DUMP TRUCK','TRUCK BOX','TRACTOR HEAD','DELIVERY VAN','DOUBLE CABIN','TRUCK BAK CRANE','CAR CARREIR','TRUCK TANGKI','BLINDVAN','TRONTON','FLAT DECK','Kereta Tempelan','Kereta Gandeng'])->where('kodepenerbitans_id', '9')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
            );
        ...
        foreach ($bulan as $dt) {
            ...
            $arr = array(
                ...
                'mobilpenumpang' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereIn('jeniskendaraan', ['Mobil Penumpang Sedan','Mobil Penumpanb Bukan Sedan'])->where('kodepenerbitans_id', '6')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                ...
                'lainlain' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereNotIn('jeniskendaraan',['Mobil Penumpang Bukan Sedan','Mobil Penumpang Sedan','Mobil Bus Kecil','Mobil Bus Sedang','Mobil Bus Besar','Mobil Bus Maxi','Kereta Tempelan','Kereta Gandeng'])->whereNotIn('model', ['PICK UP','PICK UP BOX','TRUCK','LIGHT TRUCK','DUMP TRUCK','TRUCK BOX','TRACTOR HEAD','DELIVERY VAN','DOUBLE CABIN','TRUCK BAK CRANE','CAR CARREIR','TRUCK TANGKI','BLINDVAN','TRONTON','FLAT DECK','Kereta Tempelan','Kereta Gandeng'])->where('kodepenerbitans_id', '6')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
            );
        ...
        foreach ($bulan as $dt) {
            ...
            $arr = array(
                ...
                'mobilpenumpang' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereIn('jeniskendaraan', ['Mobil Penumpang Sedan','Mobil Penumpanb Bukan Sedan'])->where('kodepenerbitans_id', '10')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                ...
                'lainlain' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereNotIn('jeniskendaraan',['Mobil Penumpang Bukan Sedan','Mobil Penumpang Sedan','Mobil Bus Kecil','Mobil Bus Sedang','Mobil Bus Besar','Mobil Bus Maxi','Kereta Tempelan','Kereta Gandeng'])->whereNotIn('model', ['PICK UP','PICK UP BOX','TRUCK','LIGHT TRUCK','DUMP TRUCK','TRUCK BOX','TRACTOR HEAD','DELIVERY VAN','DOUBLE CABIN','TRUCK BAK CRANE','CAR CARREIR','TRUCK TANGKI','BLINDVAN','TRONTON','FLAT DECK','Kereta Tempelan','Kereta Gandeng'])->where('kodepenerbitans_id', '10')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
            );
        ...
        foreach ($bulan as $dt) {
            ...
            $arr = array(
                ...
                'mobilpenumpang' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereIn('jeniskendaraan', ['Mobil Penumpang Sedan','Mobil Penumpanb Bukan Sedan'])->where('kodepenerbitans_id', '7')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'buskecil' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan',  'Mobil Bus Kecil' )->where('kodepenerbitans_id', '10')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'bussedang' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan', 'Mobil Bus Sedang' )->where('kodepenerbitans_id', '7')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'busbesar' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan', 'Mobil Bus Besar' )->where('kodepenerbitans_id', '7')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'busmaxi' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan', 'Mobil Bus Maxi' )->where('kodepenerbitans_id', '7')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'pickup' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'PICK UP')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '10')->count(),
                'pickupbox' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'PICK UP BOX')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'truck' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'TRUCK')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'lighttruck' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'LIGHT TRUCK')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'dumptruck' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'DUMP TRUCK')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'truckbox' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'TRUCK BOX')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'traktorhead' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'like', '%' . 'TRACTOR HEAD' . '%')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'deliveryvan' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'DELIVERY VAN')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'doublecabin' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'DOUBLE CABIN')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'truckbakcrane' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'TRUCK BAK CRANE')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'carcarrier' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'CAR CARREIR')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'trucktangki' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'TRUCK TANGKI')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'blindvan' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'BLINDVAN')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'tronton' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'TRONTON')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'flatdeck' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->where('jenis', 'FLAT DECK')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->where('kodepenerbitans_id', '7')->count(),
                'keretatempelan' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan', 'like', '%' . 'Kereta Tempelan' . '%')->where('kodepenerbitans_id', '7')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'keretagandeng' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->where('jeniskendaraan', 'like', '%' . 'Kereta Gandeng' . '%')->where('kodepenerbitans_id', '7')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
                'lainlain' => Pendaftaran::leftJoin('identitaskendaraans', 'identitaskendaraans.id', '=', 'pendaftarans.identitaskendaraan_id')->leftJoin('jenis', 'jenis.jenis', '=', 'identitaskendaraans.jenis')->whereNotIn('jeniskendaraan',['Mobil Penumpang Bukan Sedan','Mobil Penumpang Sedan','Mobil Bus Kecil','Mobil Bus Sedang','Mobil Bus Besar','Mobil Bus Maxi','Kereta Tempelan','Kereta Gandeng'])->whereNotIn('model', ['PICK UP','PICK UP BOX','TRUCK','LIGHT TRUCK','DUMP TRUCK','TRUCK BOX','TRACTOR HEAD','DELIVERY VAN','DOUBLE CABIN','TRUCK BAK CRANE','CAR CARREIR','TRUCK TANGKI','BLINDVAN','TRONTON','FLAT DECK','Kereta Tempelan','Kereta Gandeng'])->where('kodepenerbitans_id', '7')->whereMonth('tglpendaftaran', $dt)->whereYear('tglpendaftaran', $tahun)->count(),
            );
            array_push($dataujiulang, $arr);
        }

        return view('exports.tahunan.jenis', ['tglprint' => $tglprint, 'tglcetak' => $tglcetak, 'data' => $data, 'dataujipertama' => $dataujipertama, 'dataujiberkala' => $dataujiberkala, 'datanumasuk' => $datanumasuk, 'datanukeluar' => $datanukeluar, 'datamutasimasuk' => $datamutasimasuk, 'datamutasikeluar' => $datamutasikeluar, 'dataujiulang' => $dataujiulang]);
    }
}
