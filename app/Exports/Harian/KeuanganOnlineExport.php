...
class KeuanganOnlineExport implements FromView
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        $jml = array(
                    ...
                    'jumlah'    => Pendaftaran::Join('transaksis','transaksis.pendaftaran_id','=','pendaftarans.id')->where('tglpendaftaran',$this->tgl)->where('kodepenerbitans_id','!=','7')->where('pendaftarans.status','1')->where('transaksis.bill_paid','1')->count(),
                    );
