...
class VerifRepository
{
    ...
    {
        $data = $this->model1->leftjoin('laikjalan', 'pendaftarans.id', '=', 'laikjalan.pendaftaran_id')->where('pendaftarans.uuid', $id);
