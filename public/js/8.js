...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])(["errors"])), Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])("pos1", {
  ...
  methods: _objectSpread(_objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapMutations"])("pos1", ["CLEAR_FORM", "CLEAR_CATATAN", "SET_STATUS", "CHECK_HASILUJI"])), Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("pos1", ["submitCatatan", "getCatatan", "getAlasan"])), {}, {
    ...
    bancheck: function bancheck() {
      ...
      var alatuji_kedalamanalurban = parseFloat(this.laikjalan.alatuji_kedalamanalurban);
  ...
  methods: _objectSpread(_objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapMutations"])("pos1", ["CLEAR_FORM", "CLEAR_CATATAN", "SET_STATUS", "CHECK_HASILUJI"])), Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])("pos1", ["submitCatatan", "getCatatan", "getAlasan"])), {}, {
    ...
    setMST: function setMST() {
      if (this.identitaskendaraan.jaraksumbu2_3 > 0 || this.identitaskendaraan.jaraksumbu3_4 > 0) {
        this.identitaskendaraan.mst = Math.ceil(parseInt(this.identitaskendaraan.beratsumbu2) + parseInt(this.identitaskendaraan.dayaangkutbarang * (this.identitaskendaraan.q / (2 * this.identitaskendaraan.a))));
      } else if (this.identitaskendaraan.jaraksumbu1_2 > 0) {
        this.identitaskendaraan.mst = Math.ceil(parseInt(this.identitaskendaraan.beratsumbu2) + parseInt(this.identitaskendaraan.dayaangkutbarang * (this.identitaskendaraan.q / this.identitaskendaraan.a)));
      }
      var ambangbatasdepan = parseInt(this.identitaskendaraan.a) * 0.475;
      var ambangbatasbelakang = parseInt(this.identitaskendaraan.a) * 0.725;
      var statusFOH = 1;
      var statusROH = 1;
    ...
    checkTinggikendaraan: function checkTinggikendaraan() {
      if (parseInt(this.identitaskendaraan.tinggikendaraan) > 4200) {
        if (parseInt(this.identitaskendaraan.tinggikendaraan) > parseInt(this.identitaskendaraan.lebarkendaraan * 1.7)) {
    ...
    checkPanjangBakTangki: function checkPanjangBakTangki() {
      if (parseInt(this.identitaskendaraan.panjangbakatautangki) > parseInt(this.identitaskendaraan.panjangkendaraan)) {
    ...
    checkLebarBakTangki: function checkLebarBakTangki() {
      if (parseInt(this.identitaskendaraan.lebarbakatautangki) > parseInt(this.identitaskendaraan.lebarkendaraan)) {
    ...
    checkTinggiBakTangki: function checkTinggiBakTangki() {
      if (parseInt(this.identitaskendaraan.tinggibakatautangki) > parseInt(this.identitaskendaraan.tinggikendaraan)) {
...
/* harmony import */ var _formPengujian_FormIdentifikasi_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../formPengujian/FormIdentifikasi.vue */ "./resources/js/view/pages/formPengujian/FormIdentifikasi.vue");
/* harmony import */ var _formPengujian_FormDimensi_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../formPengujian/FormDimensi.vue */ "./resources/js/view/pages/formPengujian/FormDimensi.vue");
/* harmony import */ var _formPengujian_FormDepan_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../formPengujian/FormDepan.vue */ "./resources/js/view/pages/formPengujian/FormDepan.vue");
/* harmony import */ var _formPengujian_FormKanan_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../formPengujian/FormKanan.vue */ "./resources/js/view/pages/formPengujian/FormKanan.vue");
/* harmony import */ var _formPengujian_FormBelakang_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../formPengujian/FormBelakang.vue */ "./resources/js/view/pages/formPengujian/FormBelakang.vue");
/* harmony import */ var _formPengujian_FormKiri_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../formPengujian/FormKiri.vue */ "./resources/js/view/pages/formPengujian/FormKiri.vue");
/* harmony import */ var _formPengujian_FormDalam_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../formPengujian/FormDalam.vue */ "./resources/js/view/pages/formPengujian/FormDalam.vue");
/* harmony import */ var _formPengujian_FormBan_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../formPengujian/FormBan.vue */ "./resources/js/view/pages/formPengujian/FormBan.vue");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_2__["mapActions"])("pos1", ["submitPos", "getIdentitaskendaraan", "editPos", "CLEAR_FORM"])), Object(vuex__WEBPACK_IMPORTED_MODULE_2__["mapMutations"])("pos1", ["CLEAR_FORM", "CLEAR_CATATAN", "SET_STATUS", "CHECK_HASILUJI"])), {}, {
    submit: function submit() {
  ...
  components: {
    "identfikasi-form": _formPengujian_FormIdentifikasi_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    "dimensi-form": _formPengujian_FormDimensi_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
    "depan-form": _formPengujian_FormDepan_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    "kanan-form": _formPengujian_FormKanan_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    "belakang-form": _formPengujian_FormBelakang_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
    "kiri-form": _formPengujian_FormKiri_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
    "dalam-form": _formPengujian_FormDalam_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
    "ban-form": _formPengujian_FormBan_vue__WEBPACK_IMPORTED_MODULE_10__["default"]
  }
});
