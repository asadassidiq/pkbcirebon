...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_9__["mapState"])(["kuota"])), {}, {
    page: {
      get: function get() {
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_9__["mapActions"])("kuota", ["getKuotas", "removeKuota"])), {}, {
    ...
    customFormatter2: function customFormatter2(date) {
      var n;
      var day = moment__WEBPACK_IMPORTED_MODULE_8___default()(date).format('dddd');
      var date = moment__WEBPACK_IMPORTED_MODULE_8___default()(date).format('DD-MM-YYYY');
      switch (day) {
        case 'Sunday':
          n = 'Minggu';
          break;
